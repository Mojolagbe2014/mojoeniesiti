...
$id = '[fetched-id]'; //[fetched-id]
if(connection())
	$result = MysqlSelectQuery("SELECT * FROM `articles` where article_id= $id");/*.$_GET['fullarticle']);*/
...
<html ang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css"  href="<?php echo SITE_URL;?>css/min-all-css.css" />
