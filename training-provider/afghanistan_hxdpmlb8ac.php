  ...
  <div id="main">
	...
	?>
	 ...
	 $state =  MysqlSelectQuery("select * from states");
	  ...
	  ?>
      <li><a href="<?php echo SITE_URL.'training-provider/'.$final;?>"><?php echo $rowsState['name'];?></a></li>
      <?php
	  }
	  ?>
...
<div class="trainingProviders" style="width:100%;">
                       ...
                       <div class="trainingProviders">
						...
						<?php echo substr($rows['address'],0,100);?>
                        </span>
                        </span>
...
<div class="trainingProviders" style="width:100%;">
                       ...
                       <div class="trainingProviders">
                        ...
                        <span class="provider_name">
                        <span style="color:#000;" itemprop="address">
						<?php echo substr($rowsNonPremium['address'],0,100);?>
                        </span>
                        </span>
