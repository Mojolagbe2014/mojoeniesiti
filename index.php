...
<head>
	...
	<meta name="twitter:site" content="@nigerianseminar" />
        <meta name="twitter:image" content="<?php echo SITE_URL;?>images/facebookIMG.png" />
...
<header>
	...
	<?php if(isset($_SESSION['login_business'])||isset($_SESSION['login_subcriber'])){?>
		...
		<form action="<?php echo SITE_URL;?>logout" method="post">
			<table id="profile-table" style="width:auto;">
			<tr>
			<td><button type="submit" name="submit_login2" class="sml-btn">Logout</button></td>
			<td><button type="button" title="Back to Profile" name="subject2" class="sml-btn" onClick="window.location='login'">Profile</button></td>
			</tr>
			</table>
		</form>
	...
	<div class="Adbanner" id="topSearchBox">
        ...
        <p class="mobile-hide" id="use-advance" style="text-align:left;margin:5px 5px 5px 0px;">Search conferences, training, seminars, courses and workshops in Nigeria and around the world</p>
        <div class="basic">
	...
	<nav>
		...
		<li class="mobile-hide"><h1><a href="<?php echo SITE_URL;?>" title=Home>Home</a></h1></li>
                <li class="mobile-show-me mobile-hide" id="most-hide"><a class="mobile-enabled" data-href="<?php echo SITE_URL;?>add-event" title="Add Event">Add Event</a></li>
		<li class="mobile-show-me mobile-hide" id="hide-me"><a class="mobile-enabled" data-href="<?php echo SITE_URL;?>upload-business-info" title="Add Business">Add Business</a></li>
		<li class="mobile-show-me mobile-hide" id="shuld-hide"><a class="mobile-enabled" data-href="<?php echo SITE_URL;?>upload-vacancies" title="Add Vacancy">Add Vacancy</a></li>
		<?php if(!isset($_SESSION['login_business'])){?>
		<?php }?>
		...
		<li><a href="<?php echo SITE_URL;?>premium-listing" title="Premium Listing">Premium Listing</a></li>
                <li><a class="mobile-hide" target="_blank" href="http://blog.nigerianseminarsandtrainings.com" title="Blog">Blog</a></li>
...
<div id="main_content_body">
	...
	<tr>
	<td>
        <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/quotespg/<?php echo $newFile;?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
	</td>
	</tr>
	</table>
	...
	<div class="tags respond" id="tags" style="margin-bottom:20px">
	<div class="sneak_peak2">
...
<footer>
	...
	<div id="footer">
            <?php include('tools/upper-footer.php'); ?>
...
<script src="<?php echo SITE_URL;?>js/apps.js?<?php echo time(); ?>" type="text/javascript"></script>
...
<script>function getLagosSubDivions(division, selector){$(selector).closest('div').css({'margin-top':'3px', 'display':'block'}).fadeIn("slow");$.post("<?php echo SITE_URL; ?>tools/countries.php", {LagosSubDivisons: division}, function(data) {$(selector).html(data);});}</script>
</body>
</html>