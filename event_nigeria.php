...
$advert = "All Event";
	...
	if(isset($_GET['state'])){
		...
		$extractState = str_replace("-",' ',$_GET['state']);
...
<link href="<?php echo SITE_URL;?>images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
	...
	<title>Training / Conferences in Nigeria: Nigerian Seminars and Trainings<?php echo $pageSuffix;?></title>

<meta name="description" content="Upcoming conferences, training in Nigeria, seminars in Nigeria and workshops in Nigeria, Africa, Asia, North/South America and Oceania.<?php echo $pageSuffix;?> " />
				...
				<div class="sub_links">
					<div class="event_table_inner" style="border:solid 1px #066; background-color:#FFFFFF;">
						...
						<table width="100%" border="0">
						  ...
						  <tr>
						    <td style="padding-left:8px"><h2 style="font-size:21px; padding:5px;">Conferences, Training, Seminars, Courses and Workshops in <?php echo $_GET['state'];?></h2></td>
						    </tr>
						  <tr>
