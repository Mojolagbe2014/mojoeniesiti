...
if(isset($_POST['update'])){
  ...
  if($add_event['entrant_name'] == "")$message = errorMsg("Please enter your name");
  ...
  if(MysqlQuery("update events set name='".$add_event['entrant_name']."',email='".$add_event['email']."',phone='".$add_event['phone']."',event_title='".$add_event['title']."',venue='".$add_event['venue']."',description='".$add_event['description']."',category='".$add_event['category']."',startDate='".$add_event['start_date']."',endDate='".$add_event['end_date']."',website='".$add_event['website']."',cost='".$add_event['cost']."',organiser='".$add_event['organizer']."',facilitator='".$add_event['facilitator']."',country='".$_POST['country']."',state='".@$_POST['state']."',SortDate='$NewStartDate' ,tags='".addslashes($_POST['tags'])."', videoID='".$_POST['videoID']."', videoURL='".$_POST['videoURL']."',deals='".$_POST['deal']."', currency='".$_POST['currency']."',comment='".$_POST['comment']."',second_currency='"
    .$_POST['second_currency']."',second_cost='".$_POST['second_cost']."',second_comment='".$_POST['second_comment']."',third_currency='".
    $_POST['third_currency']."',third_cost='".$_POST['third_cost']."',third_comment='".$_POST['third_comment']."',fourth_currency='".
    $_POST['fourth_currency']."',fourth_cost='".$_POST['fourth_cost']."',fourth_comment='".$_POST['fourth_comment']."' where event_id='".$_GET['detail']."'"));
...
<?php include("scripts/menus.php");?>
  ...
  <tr>
    ...
    <td colspan="4"><span class="contact-left">
      <input name="entrant_name" type="text" class="input" id="name" value="<?php echo $rows['name'];?>"  /><br />
    </span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="4"><span class="contact-left">
      <input name="phone" type="text" class="input" value="<?php echo $rows['phone'];?>" id="phone"  />
    </span></td>
  </tr>
  <tr>
    <td align="right"><span class="contact-left">Event Title: <span style="color:#F00"> * </span></span></td>
    <td colspan="4"><span class="contact-left">
      <input name="title" type="text" class="input" id="title" value="<?php echo stripslashes($rows['event_title']);?>"  />
    </span></td>
  </tr>
  <tr>
    <td align="right" valign="top"><span class="contact-left">Event Description: <span style="color:#F00"> * </span></span></td>
    <td colspan="4"><textarea name="description" id="description" style="width: 60%; height: 200px;"><?php echo stripslashes($rows['description']);?></textarea>
     <script type="text/javascript">
  ...
  <tr>
    ...
    <td colspan="4"><select name="category" id="category" class="input">
  ...
  <tr>
    ...
    <td colspan="4"><select name="country" id="country" class="input" onchange="GetState()">
  ...
  <tr id="fee">
      ...
      <td colspan="1">
        <input name="cost" type="text" class="gui-input" value="<?php echo $rows['cost'];?>" />
      </td>
      <td>
        ...
        <div id="currency" style="width: 150px; margin-right: -18px;">
            <select name="fourth_currency" id="currency">
              ...
              <?php 
                foreach ($helper->currencies() as $key => $value)
              {?>
                <option <?php if($rows['fourth_cost']==$key) echo 'selected="selected"'; ?> value="<?php echo $key;?>"><?php echo $key;?></option>
              <?php
              }
              ?>
            </select>
  ...
  <tr>
    ...
    <td colspan="4"><span class="contact-left">
      <input name="organizer" type="text" class="input" id="organizer" value="<?php echo $rows['organiser'];?>"  />
    </span></td>
  </tr>
   <tr>
    <td align="right"><span class="contact-left">Facilitator(s): <span style="color:#F00"> * </span></span></td>
    <td colspan="4"><span class="contact-left">
      <input name="facilitator" type="text" class="input" id="facilitator" value="<?php echo $rows['facilitator'];?>"  />
    </span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="4"><span class="contact-left">
      <input name="website" type="text" class="input" value="<?php echo $rows['website'];?>" id="website"  />
    </span></td>
  </tr>
  <tr>
    <td align="right">Tags</td>
    <td colspan="2"><span class="contact-left">
      <input name="tags" type="text" class="input" value="<?php echo $rows['tags'];?>" id="tags"  />
    </span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td colspan="2"><span class="contact-left">
      <input name="videoID" type="text" class="input" value="<?php echo $rows['videoID'];?>" id="videoID"  />
    </span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td colspan="2"><span class="contact-left">
      <input name="videoURL" type="text" class="input" value="<?php echo $rows['videoURL'];?>" id="videoURL"  />
    </span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right">Deals</td>
    <td colspan="2"><textarea name="deal" id="deal" style="width: 350px; height: 100px;" class="input"><?php echo $rows['deals'];?></textarea></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
