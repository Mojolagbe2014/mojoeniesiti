...
<?php
   ...
   {*/
	 ...
	 /* $result = mysql_query("select * from quarterly_guide where name ='".$_POST['name']."'")or die(mysql_error());
      ...
      /*  $html2pdf = new HTML2PDF5('P', 'A4', 'fr', true, 'UTF-8', 0);
	 ...
	 // header("location: ../quaterly_guide?confirmation=success");
		...
		file_put_contents('../../QuarterlyGuide/'.$fileName.'_Conferences_and_Trainings_Guide.pdf', $output);*/
 ...
 // }
   /*catch(HTML2PDF_exception $e) {
	...
	header("location: ../quaterly_guide");exit;
}
?>