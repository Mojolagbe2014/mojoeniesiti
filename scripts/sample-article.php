...
<body>
  ...
  <h2 style="font-size:22px; text-align:center;">'this-article-title'</h2>
  
  <br />
  
  <div class="event_provider">
  <a href="'site-url'authorPage?id='this-article-id'" title="Authors Page">
  <p style="color:#000;"> Author:&nbsp;&nbsp;'this-article-author' </p>
  </a>
  </div>
  <!--social media-->
  ...
  <table  id="listTable">
  <tr>
  <td colspan="4"><div class="description" style="font-size:13px; text-align:justify;">'this-article-description'<br /><br />
  <div>
  <div class="articleaboutAuthor"><b>About the Author </b>- <span style="color:#000">'this-article-author'</span></div><br />
  <div> 
  <div >
  ...
  <div class="fb-like" data-href="http://www.nigerianseminarsandtrainings.com/<?php echo "article/full/'this-article-id'/".str_replace($title_link,"-","'this-article-title'");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  
  <div class="fb-share-button" data-href="http://www.nigerianseminarsandtrainings.com/<?php echo "article/full/'this-article-id'/".str_replace($title_link,"-","'this-article-title'");?>" data-type="button_count"></div>
  ...
  <div> 
  <p style="float:left; margin-right:8px;"><strong>Tags</strong></p> <?php echo tags("'this-article-tags'",'articletagsearch');?>
  <div class="clearfix"></div>
  </div>
