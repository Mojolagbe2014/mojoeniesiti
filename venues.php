...
<title> Event Centres / Venues - Nigerian Seminars and Trainings</title>
<meta name="description" content="List of event centres | event venues / halls | halls for hire for seminars, training, workshops and conferences in Nigeria <?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>"/>
<link href="images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
<meta name="keywords" content="List of event centres | event venues / halls | halls for hire for seminars, training, workshops and conferences in Nigeria " />
<meta name="dcterms.description" content="List of event centres | event venues / halls | halls for hire for seminars, training, workshops and conferences in Nigeria <?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />
<meta property="og:title" content=" Event Centres / Venues - Nigerian Seminars and Trainings <?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />
<meta property="og:description" content="List of event centres | event venues / halls | halls for hire for seminars, training, workshops and conferences in Nigeria <?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />
<meta property="twitter:title" content=" Event Centres / Venues - Nigerian Seminars and Trainings <?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />
<meta property="twitter:description" content="List of event centres | event venues / halls | halls for hire for seminars, training, workshops and conferences in Nigeria <?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />
            ...
            <div id="content_left">
                <div class="event_table_inner">
                    <form action="search_venuproviders" method="get" id="searchform" autocomplete="off">
                        <table >
                            <tr>
                            <td style="padding-left:8px"><h2 style="font-size:23px; padding:5px;font-weight: normal;">List of event centres | event venues / halls | halls for hire for seminars, training, workshops and conferences in Nigeria </h2></td>
                            </tr>
                            <tr><td><div style="margin-top:2%;text-align:center"><h3 style="font-weight:normal; font-size:11px;"><i>(Search venue provider alphabetically)</i></h3></div></td></tr>
                       </table>
                    </form>
                </div>	
                <div id="subpage">
                    <ul id="tabs">
                        <?php 
                                ...
                                foreach($alphas as $alpha){ 
                                    $sqlCmdTr = ''; $alphaStyle = '';
                                    switch($alpha){
                                        case 'PREMIUM': $sqlCmdTr = "SELECT * FROM businessinfo WHERE business_type='Venue' AND status=1 AND  premium !=0 ORDER BY RAND() "; break;
                                        default: $sqlCmdTr = "SELECT * FROM businessinfo WHERE business_type='Venue' AND status=1 AND  premium =0 AND  business_name LIKE '".$alpha."%' ORDER BY business_name ASC "; 
                                                 break;
                                    }
