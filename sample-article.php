<?php
	...
	$advert = "'this-article-advert-name'";
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta property="og:image" content="'article-image-icon'"/>
  ...
  <title><?php echo substr(trim("'this-article-title'"), 0, 65);?></title>
  <meta name="description" content="'meta-description'"/>
  <?php include("../scripts/headers_new.php");?>
  <script type="text/javascript" src="'site-url'css/smartforms/js/jquery-1.9.1.min.js"></script>
  <script type="text/javascript" src="'site-url'css/smartforms/js/jquery-ui-1.10.4.custom.min.js"></script>
  <script>
  ...
  $("#captcha").attr("src","'site-url'tools/captcha.php?r=" + Math.random());
  }
  ...
  $.post("'site-url'tools/authors-mail.php",{ name:$('#name').val(),email:$('#email').val(),message:$('#comment').val(),subject:$('#subject').val(),to:$('#to').val(),phone:$('#phone').val(),security:$('#securitycode').val(), rand:Math.random() } ,function(data)
  {
...
<body>
  ...
  <div class="imageFloat">'this-article-image'</div>
  </td>
  <td style="text-align:center;">
  <h1 style="font-size:23px; text-align:center;">'this-article-title'</h1>
  <br />
  <div class="event_provider">
  <a href="'site-url'authorPage?id='this-article-id'" title="Authors Page">
  <p style="color:#fff;"> Author:&nbsp;&nbsp;'this-article-author' </p>
  </a>
  </div>
  <!--social media-->
  <!--end social media-->
  ...
  <table  id="listTable">
  <tr>
      <td colspan="3"><div class="description" style="font-size:13px; text-align:justify;">'this-article-description'</div><br /><br />
  <div>
      <div class="articleaboutAuthor"><h2 style="font-size:13px;">About the Author - <span style="color:#000;font-weight: bold">'this-article-author'</span></h2></div><br />
  <div> 
  <div >
      <div style=" width:100%">'this-article-action-links'</div>
  </div>
  </div>
  </div>
  ...
  <a href="'this-article-author-as-link'" class="cssButton_roundedLow cssButton_aqua" style="padding:6px; font-size:12px; background-color:#435A65; color:#FFF;" title="More articles by 'this-article-author'" > More articles by 'this-article-author'</a>
  </td>
  ...
  $link = "'site-url'download_article/'this-article-id'/".stripslashes("'this-article-filename'");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "'site-url'download_article/'this-article-id'/'this-article-filename'";
  }
  ?>
  
  <a href="<?php echo $link;?>" target="_blank"  class="cssButton_roundedLow cssButton_aqua <?php echo $name;?>" onClick="GetAction('<?php echo $ArticleUrl ;?>')" style="padding:6px; font-size:12px; background-color:#435A65; color:#FFF;" title="Download full article">Download full article &nbsp;<img src="'site-url'images/pdf-icon.png" width="20" height="20" style="vertical-align:middle;" alt="pdf icon"/></a>
  </td>
  </tr>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/'this-article-id'/".str_replace($title_link,"-","'this-article-title'");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/'this-article-id'/".str_replace($title_link,"-","'this-article-title'");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("'this-article-tags'",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
  ...
  <a href="'site-url'login" >Click here</a> to login. <br /> 
  Dont have an account? <a href="'site-url'biz-info">Click here</a>
  to register as a business or <a href="'site-url'subscribers">Click here</a> 
  ...
  <strong style="color:#006600;">Contact 'this-article-author'</strong>
  ...
  <img src="'site-url'tools/captcha.php" id="captcha" alt="Captcha anti-spam image">
  ...
  <input name="to" type="hidden" value="<?php echo str_replace('@','&#64;',"'this-article-email'");?>" id="to" />
