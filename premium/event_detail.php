...
<script type="text/javascript">
  ...
  <tr>
    <td width="14%" rowspan="3" style="font-size:16px; color:#0072BC; padding-bottom:7px"><?php echo $logo;?></td>

    <td width="18%"><strong><span style="color:#0072BC; font-size:13px">Provider:</span></strong></td>

    <td colspan="4"><span style="color:#090; font-size:13px; text-transform:capitalize;"><strong><strong><?php echo $rows['organiser'];?></strong></strong></span></td>
    </tr>
  ...
  <tr>
    ...
    <td colspan="4" valign="top" style="color:#666;font-size:13px"><span style="font-size:13px"><span style="color: #F00;font-size:13px"><?php echo $rows['startDate'];?> <strong style="color:#666">to</strong> <?php echo $rows['endDate'];?></span></span></td>
    </tr>
  ...
  <tr bgcolor="#F7F7F7">
   ...
   <tr>
     <td style="color:#666;"><span style="color:#0072BC; font-size:12px"><strong>Facilitator(s):</strong></span></td>
     <td colspan="5" style="color:#666;"><?php echo $rows['facilitator'];?></td>
   </tr>
  <tr>
    <td style="color:#666;"><span style="color:#0072BC; font-size:12px"><strong><?php if($rows['tags']==""){ echo "";} else{?>Tags:<?php }?></strong></span></td>
