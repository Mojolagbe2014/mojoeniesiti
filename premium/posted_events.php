...
$advert = "Add Event";
$result = MysqlSelectQuery("select * from events WHERE user_id = '".$_SESSION['user_id']."' ORDER BY event_id desc limit $offset, $recordperpage");
?>
<!DOCTYPE html>
...
<table border="0" style="float:left; width:100%;">
  ...
  <tr>
    <td width="79%" style="padding-left:8px"><h2 style="font-size:28px; padding:5px;"><i class="fa fa-calendar"></i>&nbsp; Uploaded Event</h2></td>
...
<div id="tab_slider">
				<div id="subpage">
                <div class="event_table_inner smart-forms" style="float:left; width:97%; min-height:80px; margin-top:10px; margin-bottom:10px;  background-color:#FFFFFF;">
  ...
  <tr bgcolor="<?php echo $bg;?>">
    ...
    <td width="75%"><p><a href="<?php echo SITE_URL."events/".$rows['event_id']."/".str_replace($title_link,"-",substr($rows['event_title'],0,150))."/";?>"><?php echo $rows['event_title'];?></a></p>
      ...
      <p ><strong style="color:#090; font-size:11px">Duration: </strong><?php echo dateDiff($rows['startDate'], $rows['endDate']);?><?php echo $plan;?></p>
       ...
       <p ><a href="events_stat?evID=<?php echo $rows['event_id'];?>">View Course Performance</a></p>
      </td>
