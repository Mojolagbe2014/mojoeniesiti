...
if(isset($_POST['update'])){
	...
	if(count($errors) > 0){
		$message = ErrorCall($errors);
            ...
            if(isset($_POST['premium'])){ $addQuery = ",makePremium='".$_POST['premium']."'"; }
            else{ $addQuery = ""; }
            if($eventBrochure !=""){ 
            ...
            if($_SESSION['user_id'] != 0){
                ...
                $_POST['fourth_currency']."',fourth_cost='".$_POST['fourth_cost']."',fourth_comment='".$_POST['fourth_comment']."',vat='".$_POST['vat']."',brochure='".$eventBrochure."', last_changed = '".time()."', changed_by = '".$editedBy."', division ='".$_POST['division']."' $addQuery where event_id='".$_GET['val']."' and user_id='".$_SESSION['user_id']."'"))
...
<style>.formTable td{padding:5px;font-size:12px;}</style>
</head>
<body>
...
<tr>
<td width="79%" style="padding-left:8px"><h2 style="font-size:28px; padding:5px;"><i class="fa fa-calendar"></i>&nbsp; Edit event</h2></td>
...
<input name="premium" type="checkbox" id="premium" value="1" <?php if($rows['makePremium'] != 0){?> checked <?php } ?> />
<span class="checkbox"></span> Make Event Premium             
</label></td>
</tr>
<tr>
<td align="left"></td>
