...
<div style="display:none;">
    <img src="//pixel.quantserve.com/pixel/p-2fH5lI6K2ceJA.gif" style="border: 0px;" height="1" width="1" alt="Quantcast"/>
</div>
</noscript>
<!-- End Quantcast tag -->
...
<tr>
<td style="padding-left:8px"><h1 style="font-size:24px; padding:5px;">Submit Application</h1></td>
</tr>
<tr>
...
<form action="<?php echo SITE_URL;?>submit-application" method="post" id="applicationForm" enctype="multipart/form-data">

<table  style="border: 0px;" class="event_detail">
<tr>

<td colspan="2">

<label class="field prepend-icon">
<input name="name" type="text" class="gui-input" placeholder="Name" id="name" value="" size="40" /><strong class="field-icon"><i class="fa fa-user"></i></strong>  
</label>
...
<label class="field prepend-icon">
<input name="email" type="email" class="gui-input" placeholder="Email" id="email" value="" size="40" /><strong class="field-icon"><i class="fa fa-envelope"></i></strong>  
</label>
