...
<head>
  ...
  <title><?php echo substr(trim("The long tail: Forget squeezing millions from a few megabits at the top of the charts; the future of entertainment is in the millions of niche markets at the shallow end"), 0, 65);?></title>
  <meta name="description" content="
	In 1988, a British mountain climber named Joe Simpson wrote a book called Touching the Void, a harrowing account of near death in - 8"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">The long tail: Forget squeezing millions from a few megabits at the top of the charts; the future of entertainment is in the millions of niche markets at the shallow end</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=8" title="Authors Page">
  <p style="color:#fff;"> Author:&nbsp;&nbsp;Chris Anderson  </p>
  </a>
  </div>
  <!--social media-->
  <!--end social media-->
  ...
  <tr>
	...
	In 1988, a British mountain climber named Joe Simpson wrote a book called Touching the Void, a harrowing account of near death in the Peruvian Andes. It got good reviews but, only a modest success it was soon forgotten. Then, a decade later, a strange thing happened. Jon Krakauer wrote Into Thin Air, another book about a mountain-climbing tragedy, which became a publishing sensation. Suddenly Touching the Void started to sell again.</p>
<p style="text-align: justify;">
	Random House rushed out a new edition to keep up with demand. Booksellers began to promote it next to their Into Thin Air displays, and sales rose further. A revised paperback edition, which came out in January, spent 14 weeks on the New York Times bestseller list. That same month, IFC Films released a docudrama of the story to critical acclaim. Now, Touching the Void outsells Into Thin Air more than two to one. What happened? In short, Amazon.com recommendations. The online bookseller&#39;s software noted patterns in buying behavior and suggested that readers who liked Into Thin Air would also like Touching the Void. People took the suggestion, agreed wholeheartedly, wrote rhapsodic reviews. More sales, more algorithm-fueled recommendations, and the positive feedback loop kicked in.</p>
<p style="text-align: justify;">
	Particularly notable is that when Krakauer&#39;s book hit shelves, Simpson&#39;s was nearly out of print. A few years ago, readers of Krakauer would never even have learned about Simpson&#39;s book &mdash; and if they had, they wouldn&#39;t have been able to find it. Amazon changed that. It created the Touching the Void phenomenon by combining infinite shelf space with real-time information about buying trends and public opinion. The result: rising demand for an obscure book.</p>
<p style="text-align: justify;">
	More sales, more algorithm-fueled recommendations, and the positive feedback loop kicked in.</p>
<p style="text-align: justify;">
	This is not just a virtue of online booksellers: it is an example of an entirely new economic model for the media and entertainment industries, one that is just beginning to show its power. Unlimited selection is revealing truths about what consumers want and how they want to get it in service after service, from DVDs at Netflix to music videos on Yahoo! Launch to songs in the iTunes Music Store and Rhapsody. People are going deep into the catalog, down the long, long list of available titles, far past what&#39;s available at Blockbuster Video, Tower Records, and Barnes &amp; Noble. And the more they find, the more they like. As they wander further from the beaten path, they discover their taste is not as mainstream as they thought (or as they had been led to believe by marketing, a lack of alternatives, and a hit-driven culture). An analysis of the sales data and trends from these services and others like them shows that the emerging digital entertainment economy is going to be radically different from today&#39;s mass market. If the 20th-century entertainment industry was about hits, the 21st will be equally about misses.</p>
<p style="text-align: justify;">
	Unlimited selection is revealing truths about what consumers want and how they want to get it in service after service.</p>
<p style="text-align: justify;">
	For too long we&#39;ve been suffering the tyranny of lowest-common-denominator fare, subjected to brain-dead summer blockbusters and manufactured pop. Why? Economics. Many of our assumptions about popular taste are actually artifacts of poor supply-and-demand matching &mdash; a market response to inefficient distribution. The main problem, if that&#39;s the word, is that we live in the physical world and, until recently, most of our entertainment media did, too. But that world puts two dramatic limitations on our entertainment. The first is the need to find local audiences. An average movie theater will not show a film unless it can attract at least 1,500 people over a two-week run; that&#39;s essentially the rent for a screen. An average record store needs to sell at least two copies of a CD per year to make it worth carrying; that&#39;s the rent for a half inch of shelf space. And so on for DVD rental shops, videogame stores, booksellers, and newsstands&hellip;</p>
<p style="text-align: justify;">
	&nbsp;</p>
<p style="text-align: justify;">
	By Chris Anderson</p>
  ...
  <div>
      <div class="articleaboutAuthor"><h2 style="font-size:13px;">About the Author - <span style="color:#000;font-weight: bold">Chris Anderson </span></h2></div><br />
  <div> 
  <div >
      <div style=" width:100%"><div style="text-align:justify;  font-size:12px">Chris Anderson is Wiredʼs editor-in-chief.</div></div>
  </div>
  </div>
  </div>
  ...
  <a href="http://localhost/nigerianseminars/author/Chris-Anderson-" class="cssButton_roundedLow cssButton_aqua" style="padding:6px; font-size:12px; background-color:#435A65; color:#FFF;" title="More articles by Chris Anderson " > More articles by Chris Anderson </a>
  </td>
  ...
  $link = "http://localhost/nigerianseminars/download_article/8/".stripslashes("10.01.LongTail.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/8/10.01.LongTail.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/8/".str_replace($title_link,"-","The long tail: Forget squeezing millions from a few megabits at the top of the charts; the future of entertainment is in the millions of niche markets at the shallow end");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/8/".str_replace($title_link,"-","The long tail: Forget squeezing millions from a few megabits at the top of the charts; the future of entertainment is in the millions of niche markets at the shallow end");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Books, Sales, Demand, Consumers.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
  ...
  <strong style="color:#006600;">Contact Chris Anderson </strong>
  ...
  <input name="to" type="hidden" value="<?php echo str_replace('@','&#64;',"canderson@wiredmag.com");?>" id="to" />
