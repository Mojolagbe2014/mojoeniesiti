...
<head>
  ...
  <title><?php echo substr(trim("Roadmap to power sector reform in Nigeria"), 0, 65);?></title>
  <meta name="description" content="
	Roadmap to Power Sector Reform in Nigeria: The availability of reliable Electric Power to the homes and businesses of our Tcitizens - 12"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Roadmap to power sector reform in Nigeria</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=12" title="Authors Page">
  <p style="color:#fff;"> Author:&nbsp;&nbsp;Dr. Goodluck Ebele Jonathan, GCFR </p>
  </a>
  </div>
  <!--social media-->
  <!--end social media-->
...
&nbsp;</div></div>
  ...
  <a href="http://localhost/nigerianseminars/author/Dr.-Goodluck-Ebele-Jonathan,-GCFR" class="cssButton_roundedLow cssButton_aqua" style="padding:6px; font-size:12px; background-color:#435A65; color:#FFF;" title="More articles by Dr. Goodluck Ebele Jonathan, GCFR" > More articles by Dr. Goodluck Ebele Jonathan, GCFR</a>
  </td>
  ...
  $link = "http://localhost/nigerianseminars/download_article/12/".stripslashes("002.RoadmapToPowerSectorReformInNigeria.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/12/002.RoadmapToPowerSectorReformInNigeria.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/12/".str_replace($title_link,"-","Roadmap to power sector reform in Nigeria");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/12/".str_replace($title_link,"-","Roadmap to power sector reform in Nigeria");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Power, Electric, Roadmap, Growth, Industry, Development, ",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
  ...
  <strong style="color:#006600;">Contact Dr. Goodluck Ebele Jonathan, GCFR</strong>
