...
<head>
  ...
  <title><?php echo substr(trim("Gain Report - Nigeria - Strong growth persists in Nigeria’s wine market"), 0, 65);?></title>
  <meta name="description" content="
	Report Highlights: Average wine consumption per capita jumped from 0.1 liters to more than 0.4 liters within 2004 and 2010. Still - 26"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Gain Report - Nigeria - Strong growth persists in Nigeria’s wine market</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=26" title="Authors Page">
...
<p style="text-align: justify;">
	In Nigeria, alcoholic beverages are considered a type of food and alcohol consumption is mostly a social activity. With population, over 150 million, Nigeria provides a large market for alcoholic beverages estimated at $4.0 billion.</p>
<p style="text-align: justify;">
	Nigeria&rsquo;s beer market was worth $2.7 billion (about 70% of total alcohol market) in 2009 representing over 15 million hectoliters of beer (lager and stout types) brewed locally by multi-national processors (Heineken, Guinness, South Africa Breweries, and a few small others). They are brewed mostly with imported barley, malt and hops.</p>
<p style="text-align: justify;">
...
<p style="text-align: justify;">
	Some pineapple-based wine products and distilled gins are also formally produced and sold in the market but their share of the wine and spirits market is insignificant. Wine and spirits from traditional alcoholic products are also widely produced and consumed but they do not pass through formal channel.</p>
<p style="text-align: justify;">
	Nigeria&rsquo;s large wine market continues to show strong growth as a result of the increasing middle class as well as the gradual shift from beer to wine consumption as wine is generally perceived to be a healthier alcoholic beverage. This is creating export opportunities for U.S. wine exporters&hellip;.</p>
<p style="text-align: justify;">
	&nbsp;</p>
<p style="text-align: justify;">
...
&amp; Michael David, agricultural specialist</div></div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/26/".stripslashes("Strong_Growth_Persists_in_Nigerias_Wine Market_Lagos_Nigeria_7-1-2011.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/26/Strong_Growth_Persists_in_Nigerias_Wine Market_Lagos_Nigeria_7-1-2011.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/26/".str_replace($title_link,"-","Gain Report - Nigeria - Strong growth persists in Nigeria’s wine market");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/26/".str_replace($title_link,"-","Gain Report - Nigeria - Strong growth persists in Nigeria’s wine market");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Wine, Market, Beverages, Processors, Growth, Consumption.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
