...
<head>
  ...
  <title><?php echo substr(trim("Nominal Anchor for Monetary Policy"), 0, 65);?></title>
  <meta name="description" content="
	A nominal anchor for monetary policy is a single variable or device which the central bank uses to pin down expectations of private - 45"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Nominal Anchor for Monetary Policy</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=45" title="Authors Page">
...
<p style="text-align: justify;">
  ...
  $link = "http://localhost/nigerianseminars/download_article/45/".stripslashes("Nominal_Anchor_for_Monetary_Policy.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/45/Nominal_Anchor_for_Monetary_Policy.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/45/".str_replace($title_link,"-","Nominal Anchor for Monetary Policy");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/45/".str_replace($title_link,"-","Nominal Anchor for Monetary Policy");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Monetary, Policy, Nominal, Price, Interest, Rate, Stability.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
