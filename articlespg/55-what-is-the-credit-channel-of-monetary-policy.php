...
<head>
  ...
  <title><?php echo substr(trim("What Is The Credit Channel Of Monetary Policy Transmission?"), 0, 65);?></title>
  <meta name="description" content="
	Monetary policy works in part by altering credit flows. The use of legal reserve requirements provide monetary authorities with - 55"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">What Is The Credit Channel Of Monetary Policy Transmission?</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=55" title="Authors Page">
...
<p style="text-align: justify;">
  ...
  $link = "http://localhost/nigerianseminars/download_article/55/".stripslashes("Credit_Channel_of_Monetary_Policy_Transmission.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/55/Credit_Channel_of_Monetary_Policy_Transmission.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/55/".str_replace($title_link,"-","What Is The Credit Channel Of Monetary Policy Transmission?");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/55/".str_replace($title_link,"-","What Is The Credit Channel Of Monetary Policy Transmission?");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Monetary, Policy, Interest, Rate, Credit, Demand, Funds.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
