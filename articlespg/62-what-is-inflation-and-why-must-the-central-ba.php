...
<head>
  ...
  <title><?php echo substr(trim("What is Inflation and Why Must the Central Bank Fight Hard to subdue this Monster? How Does Inflation Affect the Ordinary Man?"), 0, 65);?></title>
  <meta name="description" content="
	A. What Is Inflation? - Inflation is one of the most frequently used terms in economic discussions, yet the concept is variously - 62"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">What is Inflation and Why Must the Central Bank Fight Hard to subdue this Monster? How Does Inflation Affect the Ordinary Man?</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=62" title="Authors Page">
...
<p style="text-align: justify;">
	Broadly, inflation can be grouped into four types, according to its magnitude.</p>
<p style="text-align: justify;">
	1. Creeping Inflation: This occurs when the rise in price is very slow. A sustained annual rise in prices of less than 3 per cent per annum falls under this category. Such an increase in prices is regarded safe and essential for economic growth.</p>
<p style="text-align: justify;">
...
<p style="text-align: justify;">
	3. Running Inflation: When prices rise rapidly at the rate of 10 to 20 per cent per annum, it is called running inflation. This type of inflation has tremendous adverse effects on the poor and middle class. Its control requires strong monetary and fiscal measures.</p>
<p style="text-align: justify;">
	4. Hyperinflation: Hyperinflation occurs when prices rise very fast at double or triple digit rates. This could get to a situation where the inflation rate can no longer be measurable and uncontrollable. Prices could rise many times everyday. Such a situation brings a total collapse of the monetary system because of the continuous fall in the purchasing power of money.</p>
<p style="text-align: justify;">
	Basically, two causes of inflation have been identified, namely, demand-pull and cost-push.</p>
<p style="text-align: justify;">
	i. Demand-pull inflation is caused by an increase in the conditions of demand. These could either be an increase in the ability to buy goods or an increase in the willingness to do so.</p>
<p style="text-align: justify;">
	ii. Cost-push inflation arises from anything that causes the conditions of supply to decrease. Some of these factors include a rise in the cost of production, an increase in government taxation and a decrease in quantity of goods produced.</p>
<p>
	B. Why Must The Central Bank Fight Inflation?</p>
<p style="text-align: justify;">
	Central banks the worlds over are obsessed about inflation and, therefore, devote a significant amount of resources at their disposal to fight inflation. Hence, the primary objective of monetary policy is to ensure price stability. The focus on price stability derives from the overwhelming empirical evidence that it is only in the midst of price stability that sustainable growth can be achieved. Price stability does not connote constant (or unchanging) price level, but it simply means that the rate of change of the general price level is such that economic agents do not worry about it. Inflationary conditions imply that the general price level keeps increasing over time. To appreciate the need to fight inflation, it is imperative to understand the implications of frequent price increases in the system. Some of these implications include:</p>
<ul>
	<li style="text-align: justify;">
		&nbsp; Discouragement of long term planning;</li>
	<li style="text-align: justify;">
		&nbsp; Reduction of savings and capital accumulation;</li>
	<li style="text-align: justify;">
		&nbsp; Reduction of investment;</li>
	<li style="text-align: justify;">
		&nbsp; Shift in the distribution of real income and consequent misallocation of resources; and</li>
	<li style="text-align: justify;">
		&nbsp; Creating uncertainty and distortions in the economy.</li>
</ul>
<p style="text-align: justify;">
	To avoid any of the situations above, central banks ensure that the price level remains stable. This is achieved by implementing policies that guard against inflation. Indeed, instability in the general price level undermines the function of money as a store of value and discourages investment and growth.</p>
<p>
	C. How Does Inflation Affect The Ordinary Man?</p>
<p style="text-align: justify;">
	Inflation affects different people or economic agents differently. Broadly, there are two economic groups in every society, the fixed income group and the flexible income group. During inflation, those in the first group lose while those in the second group gain. The reason is that the price movement of different goods and services are not uniform. During inflation, most prices rise, but the rate of increase of individual prices differ. Prices of some goods and services rise faster than others while some may even remain unchanged. The poor and the middle classes suffer because their wages and salaries are more or less fixed but the prices of commodities continue to rise. On the other hand, the businessmen, industrialists, traders, real estate holders, speculators and others with variable incomes gain during rising prices. The latter category of persons becomes rich at....</p>
</div><br /><br />
  <div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/62/".stripslashes("Seriesinflation.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/62/Seriesinflation.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/62/".str_replace($title_link,"-","What is Inflation and Why Must the Central Bank Fight Hard to subdue this Monster? How Does Inflation Affect the Ordinary Man?");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/62/".str_replace($title_link,"-","What is Inflation and Why Must the Central Bank Fight Hard to subdue this Monster? How Does Inflation Affect the Ordinary Man?");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Inflation, Purchasing, Power, Aggregate, Prices, Monetary, Policy, Stability.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
