...
<html lang="en">
<head>
  <meta property="og:image" content="http://localhost/nigerianseminars/nstlogin/articles_images/aJLjRyGTzGUeO3egq9Uu5f0b7977c617476ba3320aa436ecd369.png"/>
  ...
  <title><?php echo substr(trim("The Importance and Values of Education"), 0, 65);?></title>
  <meta name="description" content="As a parent and educationist, my passion has always been and, is still to support children in achieving their maximum potential and - 80"/>
...
<body>
  ...
  <div class="imageFloat"><img src="http://localhost/nigerianseminars/nstlogin/articles_images/aJLjRyGTzGUeO3egq9Uu5f0b7977c617476ba3320aa436ecd369.png" width="100" height="100" alt="nigerianseminarsand trainings" class="articleImg shadow"/></div>
  </td>
  <td style="text-align:center;">
  <h1 style="font-size:23px; text-align:center;">The Importance and Values of Education</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=80" title="Authors Page">
  ...
  <table  id="listTable">
  <tr>
      <td colspan="3"><div class="description" style="font-size:13px; text-align:justify;">As a parent and educationist, my passion has always been and, is still to support children in achieving their maximum potential and achieving overall happiness!<br />
<br />
I have worked with individuals from ages zero to about 21 years and have observed simple truths that are useful to their developmental needs and overall happiness.&nbsp; My joy working with these individuals has mostly come from their own discoveries and achievements and not my teaching per se.&nbsp; I believe that every individual is their own teacher and we are only directors and directresses who simply support their innate needs in the journey of learning.<br />
<br />
...
<ul>
	<li>
		A stimulating and encouraging environment that seeks out the best progress in every individual.&nbsp; This would lead to self-confidence, independence and good social skills.</li>
	<li>
		Materials and skills that enable individuals to be creative thinkers, enterprising, innovative, pro-active and problem solving people.&nbsp; We cannot excel where there are ready made answers.&nbsp; We need people in education to be masters of their own initiative.</li>
	<li>
		The curriculum should emphasize healthy lifestyle, safety and security, inclusion, integrity, beliefs, morals, social cultural development and challenge discrimination in every ramification of life.&nbsp; This could help to bridge the gap in many areas like the economic aspect and the so called disabilities.</li>
	<li>
		The curriculum should include in its subjects, the importance of personal, local, national and global development.</li>
	<li>
		The individual should be taught to take responsibilities so as to make informed decisions and face challenges with zeal.</li>
</ul>
Finally, I recommend that is important that our educational curriculum embed in it the skill required to face future adult life and be responsible citizens.</div><br /><br />
  <div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/80/".stripslashes("The_importance_and_value_of_education1.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/80/The_importance_and_value_of_education1.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/80/".str_replace($title_link,"-","The Importance and Values of Education");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/80/".str_replace($title_link,"-","The Importance and Values of Education");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Education, Potential, Identity, Yardstick, Independence, Skills, Development, Responsibilities.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
