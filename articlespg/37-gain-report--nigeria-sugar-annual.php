...
<head>
  ...
  <title><?php echo substr(trim("Gain Report - Nigeria: sugar annual      "), 0, 65);?></title>
  <meta name="description" content="
	Report Highlights: Nigeria depends almost exclusively on sugar imports in the form of brown sugar, largely imported from Brazil - 37"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Gain Report - Nigeria: sugar annual      </h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=37" title="Authors Page">
  ...
  <tr>
	...
	Report Highlights: Nigeria depends almost exclusively on sugar imports in the form of brown sugar, largely imported from Brazil (98 percent) despite privatization of all government -owned sugar resources. The Nigerian sugar industry has been reinvigorated by privatization; however, production remains insufficient to meet Nigeria&rsquo;s consumption needs. Sugar refining has flourished as new entrants increased competition in the sugar industry and refining capacity is estimated at 2.1 million tons while total demand is estimated at 1.45 million tons. The five percent duty on imported raw sugar continues to promote expansion and new investments in refining capacity, but not production.</p>
<p style="text-align: justify;">
	Executive Summary</p>
<p style="text-align: justify;">
	In order to improve Nigeria&rsquo;s sugar subsector, the Nigerian government (GON) decided to privatize all its sugar estates. The National Sugar Development Council (NSDC) was set up in 1993 and its first task was to arrange the privatization of the country&rsquo;s nationalized sugar companies. The rehabilitation of the estates has been very slow due largely to the huge capital required and lack of electricity/power to run sugar mills. The privatization process was completed in 2008 and the NSDC next aims to implement an out-grower program that will eventually run in all 14 sugar producing locations in the country. However, to date, the program has only been launched at the Savannah Sugar Company Limited, which is currently the only sugar producer in Nigeria, and also at Josepdam Sugar Company. The rehabilitation of the other sugar estates is at various stages of development.</p>
<p style="text-align: justify;">
	Nigeria&rsquo;s sugar requirements are mainly met through imports of raw sugar from Brazil (95%) that is refined locally. Currently, there are only two major companies refining sugar in Nigeria: Dangote Sugar remains the dominant player with an installed refinery capacity of 1.44 million tons; followed by the BUA Group with a capacity of 720,000 and they are also working on regenerating the infrastructure at Lafiaji in Kwara State; Flour Mills of Nigeria is doing the same in Sunti and has a second refinery coming on line in June 2012. The combined refinery capacity to date is 2.3 million tons of sugar per year, far exceeding national consumption needs estimated at 1.45 million tons. Despite the overcapacity, it is reported that two other investors are planning on establishing addition sugar refineries, potentially with the aims at export markets.</p>
<p style="text-align: justify;">
	Because of Nigeria&rsquo;s beneficial tariffs on raw sugar (subject to a duty of just 5% and exemption from the development levy) about 98 percent of all imports come in the form of raw sugar and refined locally while the remainder is imported is refined sugar.</p>
<p style="text-align: justify;">
	Exchange Rate: $1 = 158 Naira</p>
<p style="text-align: justify;">
	Commodities</p>
<p style="text-align: justify;">
	Sugar, Centrifugal</p>
...
&amp; Michael David, agricultural specialist</div></div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/37/".stripslashes("Sugar_Annual_Lagos_Nigeria_4-16-2012.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/37/Sugar_Annual_Lagos_Nigeria_4-16-2012.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/37/".str_replace($title_link,"-","Gain Report - Nigeria: sugar annual      ");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/37/".str_replace($title_link,"-","Gain Report - Nigeria: sugar annual      ");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Sugar, Privatization, Tariffs, Interest, rates, Skill, Development.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
