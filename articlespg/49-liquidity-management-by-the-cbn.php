...
<head>
  ...
  <title><?php echo substr(trim("Liquidity Management by the CBN"), 0, 65);?></title>
  <meta name="description" content="
	Liquidity management involves the supply/ withdrawal from the market the amount of liquidity consistent with a desired level of - 49"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Liquidity Management by the CBN</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=49" title="Authors Page">
  ...
  $link = "http://localhost/nigerianseminars/download_article/49/".stripslashes("Liquidity_Management_by_the_CBN.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/49/Liquidity_Management_by_the_CBN.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/49/".str_replace($title_link,"-","Liquidity Management by the CBN");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/49/".str_replace($title_link,"-","Liquidity Management by the CBN");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Liquidty, Management, Interest, Rate, Market, Price, Stability.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
