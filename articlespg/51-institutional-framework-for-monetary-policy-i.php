...
<head>
  ...
  <title><?php echo substr(trim("Institutional Framework for Monetary Policy in Nigeria"), 0, 65);?></title>
  <meta name="description" content="
	The institutional set up of the monetary policy process affects the efficacy of monetary policy. In Nigeria, the Monetary Policy - 51"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Institutional Framework for Monetary Policy in Nigeria</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=51" title="Authors Page">
...
<p style="text-align: justify;">
  ...
  $link = "http://localhost/nigerianseminars/download_article/51/".stripslashes("Institutional_framework_for_Monetary_Policy_in_Nigeria.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/51/Institutional_framework_for_Monetary_Policy_in_Nigeria.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/51/".str_replace($title_link,"-","Institutional Framework for Monetary Policy in Nigeria");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/51/".str_replace($title_link,"-","Institutional Framework for Monetary Policy in Nigeria");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Monetary, Policy, Fiscal, Liquidity, Committee.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
