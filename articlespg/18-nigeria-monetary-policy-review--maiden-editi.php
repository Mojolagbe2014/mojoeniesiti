...
<head>
  ...
  <title><?php echo substr(trim("Nigeria monetary policy review - Maiden edition 2010"), 0, 65);?></title>
  <meta name="description" content="
	I am delighted to introduce this maiden edition of the Central Bank of Nigeria (CBN) Monetary Policy Review (MPR)produced by the - 18"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Nigeria monetary policy review - Maiden edition 2010</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=18" title="Authors Page">
  <p style="color:#fff;"> Author:&nbsp;&nbsp;Central Bank Of Nigeria </p>
  </a>
  </div>
  <!--social media-->
  <!--end social media-->
  ...
  <tr>
	...
	I am delighted to introduce this maiden edition of the Central Bank of Nigeria (CBN) Monetary Policy Review (MPR)produced by the Monetary Policy Department. Although much has been written on the monetary policy process and implementation in Nigeria, there remains considerable scope for further initiatives and a more rigorous appraisal mechanism for evaluating the impact of monetary policy actions on the economy... - Sanusi Lamido Sanusi Governor, Central Bank of Nigeria.</p>
</div><br /><br />
  <div>
      <div class="articleaboutAuthor"><h2 style="font-size:13px;">About the Author - <span style="color:#000;font-weight: bold">Central Bank Of Nigeria</span></h2></div><br />
  <div> 
  <div >
      <div style=" width:100%"><div style="text-align:justify;  font-size:12px">The Central Bank of Nigeria Monetary Policy Review is published two times in a year in February and August by the Monetary Policy Department.<br />
&nbsp;<br />
The publication is designed to improve public communication of monetary policy as well as understanding of the basis for monetary policy decisions.<br />
&nbsp;<br />
The contents of the publication are therefore intended for general information only. While necessary care has been taken to ensure the accuracy<br />
Of the information contained in this publication, the CBN shall not be liable for any wrong interpretation or application of any piece of information contained herein.<br />
&nbsp;</div></div>
  </div>
  </div>
  </div>
  ...
  <a href="http://localhost/nigerianseminars/author/Central-Bank-Of-Nigeria" class="cssButton_roundedLow cssButton_aqua" style="padding:6px; font-size:12px; background-color:#435A65; color:#FFF;" title="More articles by Central Bank Of Nigeria" > More articles by Central Bank Of Nigeria</a>
  </td>
  ...
  $link = "http://localhost/nigerianseminars/download_article/18/".stripslashes("Nigeria'sMonetaryPolicyReview.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/18/Nigeria'sMonetaryPolicyReview.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/18/".str_replace($title_link,"-","Nigeria monetary policy review - Maiden edition 2010");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/18/".str_replace($title_link,"-","Nigeria monetary policy review - Maiden edition 2010");?>" data-type="button_count"></div>
  ...
  <strong style="color:#006600;">Contact Central Bank Of Nigeria</strong>
