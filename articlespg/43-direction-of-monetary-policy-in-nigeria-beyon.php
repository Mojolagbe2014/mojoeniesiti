...
<head>
  ...
  <title><?php echo substr(trim("Direction of Monetary Policy in Nigeria Beyond 2007"), 0, 65);?></title>
  <meta name="description" content="
	The current monetary policy framework is based on the targeting of bank reserves as operating target with monetary aggregates as - 43"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Direction of Monetary Policy in Nigeria Beyond 2007</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=43" title="Authors Page">
  ...
  <tr>
	...
	The current monetary policy framework is based on the targeting of bank reserves as operating target with monetary aggregates as intermediate target. The ultimate objective is to influence the general level of prices - inflation.</p>
<p style="text-align: justify;">
	Monetary targeting implied by the current practice was considered adequate as a result of the level of development of the financial system. In most industrialized economies, monetary framework in predicated on short term interest rate, set by the central bank to influence financial conditions and ultimately, aggregate demand.</p>
<p style="text-align: justify;">
	On the other hand, where financial markets are not well developed, reserve requirements are applied along with controls on interest rate and credit allocation (Fry; 2000: 4). The CBN monetary policy framework and the instruments for monetary management have been fine-tuned over the years for more robust outcomes. The Bank has kept the conditions in the financial markets under constant surveillance and has applied measures considered appropriate to stem undesired effects.</p>
<p style="text-align: justify;">
	Given the improvements in the monetary policy environment achieved in the last few years and also the need to consolidate improved inflation performance, the CBN may well be on its way to a new monetary policy framework which is direct inflation targets. The major argument for inflation targeting is that it is a better anchor for inflation expectations.</p>
<p style="text-align: justify;">
	Also, the fact that monetary aggregates&rsquo; targeting suffers from a number of limitations, which include the stability of the money multiplier and velocity of circulation of money as well as the transmission path of monetary policy, makes it less likely to produce desired outcomes on a sustainable basis.</p>
<p style="text-align: justify;">
	The major area of concern, however, is the commitment of the fiscal authorities to adhere in the future to prudent fiscal operations which will rule out financing by the banking system, especially the CBN. Current efforts aimed ensuring sustained fiscal prudence are encouraging and when institutionalized through the passage of the Fiscal Responsibility Bill, an enabling environment will be created for a more robust monetary policy.</p>
<p style="text-align: justify;">
...
<p style="text-align: justify;">
	However, if they do not believe the CBN, the anchoring of inflation expectation may be difficult. The CBN has demonstrated seriousness of purpose and credibility with the banking consolidation and the reform of the foreign exchange market.</p>
</div><br /><br />
  <div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/43/".stripslashes("What_is_the_Monetary_Policy_Process.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/43/What_is_the_Monetary_Policy_Process.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/43/".str_replace($title_link,"-","Direction of Monetary Policy in Nigeria Beyond 2007");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/43/".str_replace($title_link,"-","Direction of Monetary Policy in Nigeria Beyond 2007");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Monetary, Policy, Reserves, Prices, Inflation, Interest, Rate, Market, Credit.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
