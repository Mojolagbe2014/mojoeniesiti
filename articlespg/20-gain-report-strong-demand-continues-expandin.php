...
<head>
  ...
  <title><?php echo substr(trim("Gain Report: Strong demand continues expanding fish exports to Nigeria"), 0, 65);?></title>
  <meta name="description" content="
	Report Highlights: Imported frozen fish (especially mackerel, herring and croaker) accounted for more than 800,000 tons (valued - 20"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Gain Report: Strong demand continues expanding fish exports to Nigeria</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=20" title="Authors Page">
...
&amp; Michael David, agricultural specialist</div></div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/20/".stripslashes("StrongDemandContinuesExpandingFishExportsToNigeria_Lagos_Nigeria_12-2-2010.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/20/StrongDemandContinuesExpandingFishExportsToNigeria_Lagos_Nigeria_12-2-2010.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/20/".str_replace($title_link,"-","Gain Report: Strong demand continues expanding fish exports to Nigeria");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/20/".str_replace($title_link,"-","Gain Report: Strong demand continues expanding fish exports to Nigeria");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Imports, Fish, Market, Consumption, Demand, Growth.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
