...
<html lang="en">
<head>
  <meta property="og:image" content="http://localhost/nigerianseminars/nstlogin/articles_images/LGUCXUCQI04Z1j8mimeg34de0d9f674c889fa0345dc22a0f5ddb.JPG"/>
  ...
  <title><?php echo substr(trim("What Got You Here, Won’t Get You There"), 0, 65);?></title>
  <meta name="description" content="
	The importance of developing aspiring leaders - One of the most significant challenges faced by organisations is how to support - 64"/>
...
<body>
  ...
  <div class="imageFloat"><img src="http://localhost/nigerianseminars/nstlogin/articles_images/LGUCXUCQI04Z1j8mimeg34de0d9f674c889fa0345dc22a0f5ddb.JPG" width="100" height="100" alt="nigerianseminarsand trainings" class="articleImg shadow"/></div>
  </td>
  <td style="text-align:center;">
  <h1 style="font-size:23px; text-align:center;">What Got You Here, Won’t Get You There</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=64" title="Authors Page">
  ...
  <tr>
	...
	The importance of developing aspiring leaders - One of the most significant challenges faced by organisations is how to support and enable a smooth and seamless transition to team leadership roles.</p>
<p style="text-align: justify;">
	The technical skills and abilities that were critical to individuals in the past, contribute only 15% on their ability to make an impact today. So what about the balance of 85%? Just what are those skills, knowledge and behaviours critical to successful first time / line leadership? And how can organisations support and enable leaders on their leadership &ldquo;journey&rdquo;.</p>
<p style="text-align: justify;">
	Producing a list of critical behaviour, skills and knowledge consistent with effective first time/line leadership is easy. However, the reality of acquiring, developing and applying them as and when situations arise is another story. So just what can organisations and existing leaders do to ensure first time / line leaders are provided with the best possible chances of success?</p>
<p style="text-align: justify;">
	Organisations surely need a representative, meaningful and user-friendly definition of what effective first time / line leadership looks and feels like. If we embark upon the leadership journey with no destination, we will for sure arrive there.</p>
<p style="text-align: justify;">
	This framework should consist of no more than six categories that accurately describe what outstanding leadership consists of. These leadership competencies then need to be used for key HR practices &ndash; recruitment, selection and development of leaders in the organisation.</p>
<p style="text-align: justify;">
...
<p style="text-align: justify;">
	Organisations must take full advantage of existing skills and knowledge which are evident in their leadership team. Training leaders as coaches and mentors and supporting them through coaching supervision is critical to developing &ldquo;home grown&rdquo; talent.</p>
<p style="text-align: justify;">
	It is also important for aspiring leaders to appreciate the importance of committing to self-development: Taking personal responsibility for continuing professional development rather than constantly looking upwards for things to be &ldquo;done to and for them&rdquo;.</p>
<p style="text-align: justify;">
	There are numerous examples of organisations that wish to short circuit the process and adopt an Elastoplast quick fix solution &ndash; to development. Bringing about sustainable change requires a longer term and more focused approach. Personal development is a journey not an event.</p>
<p style="text-align: justify;">
	If we are serious about enabling individuals successfully navigate their way on the leadership career we must surely prepare them for the journey. Having an aspiring leader&rsquo;s development programme which incorporates a variety of learning processes is just sound economic business sense. Engagement and sustainable commitment of all interested parties to the development of new leaders is of upmost importance.</p>
<p style="text-align: justify;">
	You can only really influence an outcome &ndash; make a difference - by being on the &ldquo;field of play&rdquo;.</p>
<p style="text-align: justify;">
	Enable people to move from spectatorship to positive ownership.</p>
<p style="text-align: justify;">
	GTC has significant experience in the design, implementation, and evaluation of leadership development programmes. We would be delighted to speak to any organisations that have an interest in developing this most valuable and precious resource.</p>
<p style="text-align: justify;">
	For more information about GTC, visit www.thegtcgroup.com.</p>
</div><br /><br />
  <div>
...
<p>
  ...
  $link = "http://localhost/nigerianseminars/download_article/64/".stripslashes("What_Got_You_Here,_Won’t_Get_You_There.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/64/What_Got_You_Here,_Won’t_Get_You_There.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/64/".str_replace($title_link,"-","What Got You Here, Won’t Get You There");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/64/".str_replace($title_link,"-","What Got You Here, Won’t Get You There");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Leadership, Organisation, Skills, Development, Recruitment. ",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
