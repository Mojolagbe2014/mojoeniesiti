...
<head>
  ...
  <title><?php echo substr(trim("Monetary Policy Instruments Used By the CBN"), 0, 65);?></title>
  <meta name="description" content="
	Until about 1993 when OMO was introduced, the CBN relied almost exclusively on varying combinations of direct instruments of monetary - 47"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Monetary Policy Instruments Used By the CBN</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=47" title="Authors Page">
...
<p style="text-align: justify;">
  ...
  $link = "http://localhost/nigerianseminars/download_article/47/".stripslashes("Monetary_Policy_Instruments_used_by_the_CBN.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/47/Monetary_Policy_Instruments_used_by_the_CBN.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/47/".str_replace($title_link,"-","Monetary Policy Instruments Used By the CBN");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/47/".str_replace($title_link,"-","Monetary Policy Instruments Used By the CBN");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Securities, Market, Liabilities, Interest, Monetary, Policy, Forex.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
