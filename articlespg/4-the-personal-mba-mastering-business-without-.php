...
<head>
  ...
  <title><?php echo substr(trim("The personal MBA: Mastering business without spending a fortune"), 0, 65);?></title>
  <meta name="description" content="
	Business schools do not have a monopoly on worldly wisdom. If you care more about increasing your effectiveness at work than a diploma - 4"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">The personal MBA: Mastering business without spending a fortune</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=4" title="Authors Page">
  <p style="color:#fff;"> Author:&nbsp;&nbsp;Josh Kaufman  </p>
  </a>
  </div>
  <!--social media-->
  <!--end social media-->
  ...
  <tr>
	...
	Business schools do not have a monopoly on worldly wisdom. If you care more about increasing your effectiveness at work than a diploma and a few lines on your resume, the Personal MBA is for you.</p>
<p>
	What is the Personal MBA?</p>
<p>
	&ldquo; You wasted $150,000 on an education you coulda got for a buck fifty in late charges at the public library.&rdquo; &mdash; Will Hunting (played by Matt Damon), Good Will Hunting</p>
<p>
	The Personal MBA (PMBA) is an experiment in educational entrepreneurism. This manifesto will show you how to substantially increase your knowledge of business on your own time and with little cost, all without setting foot inside a classroom. The PMBA is more flexible than a traditional MBA program, doesn&rsquo;t involve going into massive debt, and won&rsquo;t interrupt your income stream for two years. Just set aside some dedicated reading time, pick up a good book, learn as much as you can, and go out and make great things happen.</p>
<p>
	It&rsquo;s all about the books</p>
<p>
	&ldquo; If I read a book that cost me $20 and I get one good idea, I&rsquo;ve gotten one of the greatest bargains of all time.&rdquo; &mdash; Tom Peters</p>
<p>
	&ldquo; The difference between where you are today and where you&rsquo;ll be five years from now will be found in the quality of books you&rsquo;ve read.&rdquo; &mdash; Jim Rohn</p>
<p>
	At the core of the PMBA is a list of 42 books and periodicals. By investing time and effort in using these resources, you will progressively develop a greater understanding of business and increase your effectiveness at work. Even if you only read a few, you&rsquo;ll get a substantial return on your investment.</p>
<p>
	Thoughts on traditional MBA programs</p>
<p>
	&ldquo; Whatever be the qualifications of your tutors, your improvement must chiefly depend on yourselves. They cannot think or labor for you, they can only put you in the best way of thinking and laboring for yourselves. If therefore you get knowledge you must acquire it by your own industry. You must form all conclusions and all maxims for yourselves, from premises and data collected and considered by yourself. And it is the great object of [our educational institutions] to remove every bias the mind may be under, and to give the greatest scope for true freedom of thinking.&rdquo;</p>
<p>
	&mdash; Joseph Priestly, Dedication of New College, London, 1794.</p>
<p>
	The debate concerning the value of traditional MBA programs is long and involved, and this manifesto won&rsquo;t close the issue.a For the sake of brevity, here&rsquo;s a short Q&amp;A on the pros and cons of business school:</p>
<p>
	Can a traditional MBA program help you? Yes. You&rsquo;ll meet a lot of great people and get acquainted with a few professors and corporate HR recruiters who can help you land a new job. You will also sink very deep into debt. If you decide to enroll in a full-time program, the opportunity cost of lost wages and future investable savings is huge</p>
<p>
	Will a traditional MBA teach you anything you can&rsquo;t learn by yourself? Probably not. Classroom discussion can be beneficial, but there&rsquo;s nothing presented that you can&rsquo;t learn by studying a good book on the subject.</p>
<p>
	Is a traditional MBA worth the time and money? Sorry &mdash; there&rsquo;s no universal answer. If you&rsquo;re looking to go into advanced corporate accounting, finance, quantitative analysis, commercial real estate, consulting, venture capital, or investment banking, an MBA or MS in a&nbsp; business-related field may be expected or required. In those cases, caveat emptor: once you decide to attend, the only certainty is that your bank account will be significantly smaller. If you decide not to go to business school, the Personal MBA is a low cost way to educate yourself about business. (Even business school graduates can benefit greatly from reading these books.) Before we get to the list, however, allow me to set a few reasonable expectations about the PMBA&hellip;.</p>
<p>
	&nbsp;</p>
<p>
	By Josh Kaufman</p>
  ...
  <div>
      <div class="articleaboutAuthor"><h2 style="font-size:13px;">About the Author - <span style="color:#000;font-weight: bold">Josh Kaufman </span></h2></div><br />
  <div> 
  <div >
      <div style=" width:100%"><div style="text-align:justify;  font-size:12px">Josh just graduated from the University Of Cincinnati College Of Business with concentrations in Business Information Systems, Real Estate, and Philosophy. He has worked at Procter &amp; Gamble for three years as a part of UC&rsquo;s cooperative education program, and will be starting full-time at P&amp;G this fall.<br />
He has no intention of getting an MBA any time soon, but he does have a lot of good books to read. You can find him discussing the Personal MBA at http://www.personalmba.com, or on his blog at http://www.joshkaufman.net</div></div>
  </div>
  </div>
  </div>
  ...
  <a href="http://localhost/nigerianseminars/author/Josh-Kaufman-" class="cssButton_roundedLow cssButton_aqua" style="padding:6px; font-size:12px; background-color:#435A65; color:#FFF;" title="More articles by Josh Kaufman " > More articles by Josh Kaufman </a>
  </td>
  ...
  $link = "http://localhost/nigerianseminars/download_article/4/".stripslashes("17.05.PersonalMBA.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/4/17.05.PersonalMBA.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/4/".str_replace($title_link,"-","The personal MBA: Mastering business without spending a fortune");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/4/".str_replace($title_link,"-","The personal MBA: Mastering business without spending a fortune");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Entrepreneurism, Business, Traditional, Resources.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
  ...
  <strong style="color:#006600;">Contact Josh Kaufman </strong>
