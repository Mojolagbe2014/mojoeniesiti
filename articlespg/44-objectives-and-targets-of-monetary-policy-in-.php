...
<head>
  ...
  <title><?php echo substr(trim("Objectives and Targets of Monetary Policy in Nigeria"), 0, 65);?></title>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Objectives and Targets of Monetary Policy in Nigeria</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=44" title="Authors Page">
  ...
  <tr>
	...
	In Nigeria, the major objectives of policy are the attainment of price stability and sustainable economic growth.</p>
<p style="text-align: justify;">
	Associated objectives are those full employment and stable long-term interest rates and real exchange rates. In pursuing these objectives, the CBN recognises the existence of conflicts among objectives necessitating at some point some sort of trade-offs.</p>
<p style="text-align: justify;">
	The targets of monetary policy are in the case of the CBN are the operational target, the intermediate target and the ultimate targets. The Bank manipulates the operating target (reserve money) over which it has substantial direct control to influence the intermediate target (broad money supply, M2) which in turn impacts on the ultimately or final objective of monetary policy, i.e., inflation and output.</p>
<p style="text-align: justify;">
	The broad money supply (M2) comprises narrow money (M1) and quasi money while the operating targets, reserve money is made up of currency in circulation and bank deposits with the central bank.</p>
</div><br /><br />
  <div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/44/".stripslashes("Objectives_and_Targets_of_Monetary_Policy.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/44/Objectives_and_Targets_of_Monetary_Policy.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/44/".str_replace($title_link,"-","Objectives and Targets of Monetary Policy in Nigeria");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/44/".str_replace($title_link,"-","Objectives and Targets of Monetary Policy in Nigeria");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Policy, Price, Growth, Interest, Rate, Monetary, Target, Inflation, Money.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
