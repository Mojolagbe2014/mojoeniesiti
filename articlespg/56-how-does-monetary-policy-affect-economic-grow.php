...
<head>
  ...
  <title><?php echo substr(trim("How Does Monetary Policy Affect Economic Growth?"), 0, 65);?></title>
  <meta name="description" content="
	The central bank tries to maintain price stability through controlling the level of money supply. Thus, monetary policy plays a - 56"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">How Does Monetary Policy Affect Economic Growth?</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=56" title="Authors Page">
...
<p style="text-align: justify;">
  ...
  $link = "http://localhost/nigerianseminars/download_article/56/".stripslashes("MPIandEconomicGrowth.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/56/MPIandEconomicGrowth.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/56/".str_replace($title_link,"-","How Does Monetary Policy Affect Economic Growth?");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/56/".str_replace($title_link,"-","How Does Monetary Policy Affect Economic Growth?");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Price, Stability, Monetary, Policy, Growth, Risks, Interest, Rate.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
