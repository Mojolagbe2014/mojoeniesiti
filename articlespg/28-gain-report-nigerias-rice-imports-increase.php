...
<head>
  ...
  <title><?php echo substr(trim("Gain Report: Nigeria's rice imports increase"), 0, 65);?></title>
  <meta name="description" content="
	Report Highlights: Nigeria&#39;s rice imports have increased largely because imported parboiled rice competes with other basic food - 28"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Gain Report: Nigeria's rice imports increase</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=28" title="Authors Page">
...
&amp; Michael David, agricultural specialist</div></div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/28/".stripslashes("Rice_Trade-Quarterly_Lagos_Nigeria_9-28-2011.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/28/Rice_Trade-Quarterly_Lagos_Nigeria_9-28-2011.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/28/".str_replace($title_link,"-","Gain Report: Nigeria's rice imports increase");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/28/".str_replace($title_link,"-","Gain Report: Nigeria's rice imports increase");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Rice, Imports, Ban, Production, Agriculture.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
