...
<html lang="en">
<head>
  <meta property="og:image" content="http://localhost/nigerianseminars/nstlogin/articles_images/KoIODZhABmYqvW0913mAd587f4daba342c035bb95d33f9b221a4.JPG"/>
  ...
  <title><?php echo substr(trim("Don’t Do Goals? Then See a Priest"), 0, 65);?></title>
  <meta name="description" content="
	There are many benefits to having a structure that provides us with a way of making sense of our world and bringing fulfillment - 68"/>
...
<body>
  ...
  <div class="imageFloat"><img src="http://localhost/nigerianseminars/nstlogin/articles_images/KoIODZhABmYqvW0913mAd587f4daba342c035bb95d33f9b221a4.JPG" width="100" height="100" alt="nigerianseminarsand trainings" class="articleImg shadow"/></div>
  </td>
  <td style="text-align:center;">
  <h1 style="font-size:23px; text-align:center;">Don’t Do Goals? Then See a Priest</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=68" title="Authors Page">
  ...
  <tr>
	...
	There are many benefits to having a structure that provides us with a way of making sense of our world and bringing fulfillment and achievement. Yet people have real issues with setting and maintaining meaningful goals. If you find goal-setting an issue, then help is at hand! Instead of thinking about goals, think in terms of outcomes or even better why not have fantastic outcomes? So what&rsquo;s the difference between goals and outcomes? A goal is a single step on the road to an outcome and all steps/goals should be easily achievable or you will trip and fall.</p>
<p style="text-align: justify;">
	Here is a model for setting well-formed (Fantastic) outcomes: <strong>P. R . I .E .S .T.</strong></p>
<p>
	<strong><em>Positive</em>:</strong> The outcome must be framed in the positive. It is more motivational to move towards what we want, as&nbsp; opposed to things we don&rsquo;t want. There is also the power of focus. If we focus on what we want, then we are likely to move towards making that happen. The same is true of those things we don&rsquo;t want, if we focus on them, we get more of that!</p>
<p>
	<em><strong>Resources</strong>:</em> What internal and external resources will you need to achieve your outcome? Internal resources include things such as: Courage, persistence, assertiveness. External resources are related to finance, time, and support from boss or colleagues.</p>
<p>
	<strong><em>Initiated and maintained by you</em>:</strong> You are responsible and need to take full responsibility from the start to the end, no excuses.</p>
<p>
	<strong>Ecology Check:</strong> Who else will be affected by this outcome? Will there be some benefits for others? Will there be downsides for others, during or after a successful outcome?</p>
<p>
	<strong><em>Sensory Evidence:</em></strong> During and on completion of the outcome, what will you see, hear and feel? This sensory based objective-setting moves you powerfully towards a successful result.</p>
<p>
	<strong><em>Time:</em></strong> How long will this take? How much of your time will this take up? What will you have to give up to make room for this?</p>
<p style="text-align: justify;">
	Adapted from original text by Mervyn Murray, Leadership Trainer at GTC</p>
</div><br /><br />
  <div>
...
<p>
  ...
  $link = "http://localhost/nigerianseminars/download_article/68/".stripslashes("Don’t_do_goals_Then_see_a_priest.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/68/Don’t_do_goals_Then_see_a_priest.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/68/".str_replace($title_link,"-","Don’t Do Goals? Then See a Priest");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/68/".str_replace($title_link,"-","Don’t Do Goals? Then See a Priest");?>" data-type="button_count"></div>
