...
<head>
  ...
  <title><?php echo substr(trim("What is the Exchange Rate Channel of Monetary Policy Transmission?"), 0, 65);?></title>
  <meta name="description" content="
	The central bank use monetary policy to achieve the goals of macroeconomic management. Consequently, monetary policy is employed - 52"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">What is the Exchange Rate Channel of Monetary Policy Transmission?</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=52" title="Authors Page">
  ...
  <tr>
	...
	The central bank use monetary policy to achieve the goals of macroeconomic management. Consequently, monetary policy is employed as a tool to control or influence monetary aggregates such as interest rates, money supply and bank credit, including the exchange rate, with a view to achieving set policy targets such as tackling unemployment, inflation, economic growth, etc. In this regard therefore, monetary policy plays an important role towards achieving the ultimate economic objectives of sustainable growth, full employment, price stability and a healthy balance of payments. In the pursuit of these goals, the central bank sets intermediate objectives for monetary policy. These are goals which relate to using interest rates, growth in money supply and the exchange rate to achieve the ultimate goals of monetary management. In other words, the intermediate goals are regarded as channels through which monetary policy is transmitted to the macro economy with the aim of impacting on the ultimate objectives.</p>
<p style="text-align: justify;">
	The exchange Rate is one of the intermediate policy variables through which monetary policy is transmitted to the larger economy through its impact on the value of domestic currency, domestic inflation (the pass-through effect), the external sector, macroeconomic credibility, capital flows, and financial stability. Thus, changes in the exchange rate might induce changes in the relative prices of goods and services, and the level of spending by individuals and firms, especially if significant levels of their wealth are held in foreign currencies. An appreciation in the value of the exchange rate rise makes imported goods and services relatively cheap, while depreciation makes exports become cheaper to foreign buyers, thereby inducing higher competition in export markets at home. On the other hand, with depreciation, imports become more expensive and so less competitive against goods produced by domestic producers. Changes in the exchange rate therefore, have implications for individual spending and investments behavior of firms, all of which can affect aggregate demand (an important determinant of economic growth, price stability and full employment in the macro economy). However, there is a growing debate among monetary economists; whether in the current medium-term orientation of monetary policy, the exchange rate is still significant as a relevant transmission channel for monetary policy.</p>
</div><br /><br />
  <div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/52/".stripslashes("The_exchange_rate_channel_of_MPT.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/52/The_exchange_rate_channel_of_MPT.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/52/".str_replace($title_link,"-","What is the Exchange Rate Channel of Monetary Policy Transmission?");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/52/".str_replace($title_link,"-","What is the Exchange Rate Channel of Monetary Policy Transmission?");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Monetary, Policy, Interest, Rates, Inflation, Growth, Exchange, Stability",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
