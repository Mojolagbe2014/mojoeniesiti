...
<head>
  ...
  <title><?php echo substr(trim("Gain Report - Nigeria: rice trade quarterly"), 0, 65);?></title>
  <meta name="description" content="
	Report Highlights: The Government of Nigeria (GON) has resolved to encourage domestic rice production by restricting rice imports - 32"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Gain Report - Nigeria: rice trade quarterly</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=32" title="Authors Page">
  ...
  <tr>
	...
	Report Highlights: The Government of Nigeria (GON) has resolved to encourage domestic rice production by restricting rice imports to conserve foreign exchange. Rice importers now import rice from India following the recent reentry of that country into the non-basmati rice trade.</p>
...
&amp; Michael David, agricultural specialist</div></div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/32/".stripslashes("Rice_Trade-Quarterly_Lagos_Nigeria_12-7-2011.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/32/Rice_Trade-Quarterly_Lagos_Nigeria_12-7-2011.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/32/".str_replace($title_link,"-","Gain Report - Nigeria: rice trade quarterly");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/32/".str_replace($title_link,"-","Gain Report - Nigeria: rice trade quarterly");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Rice, Production, Imports, Agriculture, Interest, Incentives.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
