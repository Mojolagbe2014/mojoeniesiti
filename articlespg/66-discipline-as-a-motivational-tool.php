...
<html lang="en">
<head>
  <meta property="og:image" content="http://localhost/nigerianseminars/nstlogin/articles_images/nkYYMZrZYwcKJXyHfHUu3de6b2712ff9b267fb76dab7aa336808.JPG"/>
  ...
  <title><?php echo substr(trim("Discipline as a Motivational Tool"), 0, 65);?></title>
  <meta name="description" content="
	It is never a nice thing to dismiss people for poor performance or for transgressions of disciplinary rules. Many managers dread - 66"/>
...
<body>
  ...
  <div class="imageFloat"><img src="http://localhost/nigerianseminars/nstlogin/articles_images/nkYYMZrZYwcKJXyHfHUu3de6b2712ff9b267fb76dab7aa336808.JPG" width="100" height="100" alt="nigerianseminarsand trainings" class="articleImg shadow"/></div>
  </td>
  <td style="text-align:center;">
  <h1 style="font-size:23px; text-align:center;">Discipline as a Motivational Tool</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=66" title="Authors Page">
  <p style="color:#fff;"> Author:&nbsp;&nbsp;GTC </p>
  </a>
  </div>
  <!--social media-->
  <!--end social media-->
  ...
  <tr>
	...
	It is never a nice thing to dismiss people for poor performance or for transgressions of disciplinary rules. Many managers dread having &ldquo;The Disciplinary Conversation&rdquo; with a member of their team. They will:</p>
<ul>
	<li>
		Ignore behaviour</li>
	<li>
		Be in denial that there is an issue</li>
	<li>
		Take a small &ldquo;stab&rdquo; at the issue hoping for a result</li>
	<li>
		Move the person onto another department</li>
	<li>
		Make the person feel unwanted</li>
	<li>
		Use sarcasm to make a point</li>
</ul>
<p style="text-align: justify;">
	None of which is helpful for the staff member, the team or the reputation of the manager and his/ her organisation. It certainly does nothing for increased performance and results.</p>
<p style="text-align: justify;">
	The good news is that we can use the disciplinary process as a motivational tool, when used with care, empathy and a good degree of determination.</p>
<p style="text-align: justify;">
	There is a 5-step model for having &ldquo;The Disciplinary Conversation&rdquo; that managers may find helpful, however there is an important step everyone should take before embarking on this effective disciplinary process. Take legal advice first and let them know what you intend to say and do. Respect your country employment law when you come to implement the steps.</p>
<p style="text-align: justify;">
	The approach to take is to first:</p>
<ul>
	<li style="text-align: justify;">
		Pinpoint the behaviour you want</li>
</ul>
<p style="text-align: justify;">
	Nail exactly what is required and write this in your records and for clarity during your conversations</p>
<ul>
	<li style="text-align: justify;">
		Record the facts</li>
</ul>
<p style="text-align: justify;">
	Record facts, not hearsay, input from others should be based on unemotional details, not points of view</p>
<ul>
	<li style="text-align: justify;">
		Involve the person</li>
</ul>
<p style="text-align: justify;">
	Ask them what they think. It is easy for the manager to be judge and jury, resist the urge to jump to conclusions</p>
<ul>
	<li style="text-align: justify;">
		Coach the person</li>
</ul>
<p style="text-align: justify;">
	Make the person understand the situation and their behaviour so that they value your intervention and realise that you are by their side, wanting and supporting their success.</p>
<ul>
	<li style="text-align: justify;">
		Evaluate progress</li>
</ul>
<p style="text-align: justify;">
	Hold regular stewardship interviews to ensure they are on track. Be a cheerleader for their successes, big and small.</p>
</div><br /><br />
  <div>
      <div class="articleaboutAuthor"><h2 style="font-size:13px;">About the Author - <span style="color:#000;font-weight: bold">GTC</span></h2></div><br />
  <div> 
  <div >
      <div style=" width:100%"><div style="text-align:justify;  font-size:12px"><p>
	GTC is a UK based international capacity-building organization that provides training, consultancy and specialized solutions for public and private sectors of emerging economies such as Africa, Asia and Middle East.</p>
<p>
	The company has significant experience in the design, implementation and evaluation of leadership development programmes and other senior executive programmes.</p>
<p>
	For more information about GTC programmes, visit <a href="http://www.thegtcgroup.com/">www.thegtcgroup.com.</a></p>
</div></div>
  </div>
  </div>
  </div>
  ...
  <a href="http://localhost/nigerianseminars/author/GTC" class="cssButton_roundedLow cssButton_aqua" style="padding:6px; font-size:12px; background-color:#435A65; color:#FFF;" title="More articles by GTC" > More articles by GTC</a>
  </td>
  ...
  $link = "http://localhost/nigerianseminars/download_article/66/".stripslashes("Discipline_as_a_Motivational_Tool.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/66/Discipline_as_a_Motivational_Tool.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/66/".str_replace($title_link,"-","Discipline as a Motivational Tool");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/66/".str_replace($title_link,"-","Discipline as a Motivational Tool");?>" data-type="button_count"></div>
  ...
  <strong style="color:#006600;">Contact GTC</strong>
  ...
  <input name="to" type="hidden" value="<?php echo str_replace('@','&#64;',"francine.beleyi@thegtcgroup.com");?>" id="to" />
