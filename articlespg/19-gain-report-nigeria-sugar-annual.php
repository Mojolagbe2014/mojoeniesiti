...
<head>
  ...
  <meta name="description" content="
	Report Highlights: Nigeria continues to depend almost exclusively on sugar imports despite the completion of the privatization of - 19"/>
...
<body>
  ...
  <a href="http://localhost/nigerianseminars/authorPage?id=19" title="Authors Page">
...
<p style="text-align: justify;">
	The bulk of Nigeria&rsquo;s sugar requirement is satisfied through imports of raw sugar from Brazil that is refined locally. At present, there are only two major companies refining sugar in Nigeria: Dangote Sugar remains the dominant player with a refinery capacity of 1.44 million tons followed by BUA Sugar Refinery with a capacity of 720,000 tons per year. The combined capacity of the two refineries is 2.3 million tons of sugar per year, far exceeding national consumption estimated at 1.4 million tons. Despite the overcapacity, it is reported that two other investors plan to establish sugar refineries.</p>
<p style="text-align: justify;">
	Because of Nigeria&rsquo;s beneficial tariffs on raw sugar, about 90 percent of all imports come as raw sugar and refined locally, while the remainder is imported in refined form. &nbsp;</p>
<p style="text-align: justify;">
	Exchange Rate: $1 = 150 Naira</p>
<p style="text-align: justify;">
	Commodities:</p>
<p style="text-align: justify;">
	Sugar, Centrifugal</p>
...
&amp; Michael David, agricultural specialist</div></div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/19/".stripslashes("SugarAnnual_Lagos_Nigeria_4-14-2011.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/19/SugarAnnual_Lagos_Nigeria_4-14-2011.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/19/".str_replace($title_link,"-","Gain Report: Nigeria sugar annual");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/19/".str_replace($title_link,"-","Gain Report: Nigeria sugar annual");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Sugar, Imports, Estates, Privatization, Consumption, Refineries, Development.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
