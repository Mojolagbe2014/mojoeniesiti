...
<head>
  ...
  <title><?php echo substr(trim("Banks in Nigeria and national economic development: A critical review"), 0, 65);?></title>
  <meta name="description" content="
	Protocol: 1. I am very delighted to be invited to present a key-note address at this important forum. I wish to commend the organizers, - 24"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Banks in Nigeria and national economic development: A critical review</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=24" title="Authors Page">
...
<p style="text-align: justify;">
  ...
  $link = "http://localhost/nigerianseminars/download_article/24/".stripslashes("Gov_BanksInNigeriaAndNationalEconomicDevelopment_chc-cibn-rbc_040611.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/24/Gov_BanksInNigeriaAndNationalEconomicDevelopment_chc-cibn-rbc_040611.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/24/".str_replace($title_link,"-","Banks in Nigeria and national economic development: A critical review");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/24/".str_replace($title_link,"-","Banks in Nigeria and national economic development: A critical review");?>" data-type="button_count"></div>
