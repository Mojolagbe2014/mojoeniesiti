...
<html lang="en">
<head>
  <meta property="og:image" content="http://localhost/nigerianseminars/nstlogin/articles_images/kvsZamIQ0gaxoinKKpXy332a32b5ca31c840561df640ec2d30d5.JPG"/>
  ...
  <title><?php echo substr(trim("A 10-Step Process to Delegate Effectively"), 0, 65);?></title>
  <meta name="description" content="
	Effective delegation is a skill which is often overlooked by busy managers who think that they already do this well enough. However - 77"/>
...
<body>
  ...
  <div class="imageFloat"><img src="http://localhost/nigerianseminars/nstlogin/articles_images/kvsZamIQ0gaxoinKKpXy332a32b5ca31c840561df640ec2d30d5.JPG" width="100" height="100" alt="nigerianseminarsand trainings" class="articleImg shadow"/></div>
  </td>
  <td style="text-align:center;">
  <h1 style="font-size:23px; text-align:center;">A 10-Step Process to Delegate Effectively</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=77" title="Authors Page">
  ...
  <tr>
	...
	Effective delegation is a skill which is often overlooked by busy managers who think that they already do this well enough. However during our training and workshops we discover that many managers have completely the wrong idea about what effective delegation actually is and the benefits that can be derived from doing it well. First, let&rsquo;s define effective delegation. Effective delegation is when a leader charges a subordinate with the authority to take decisions within defined areas of responsibility. The leader is still accountable.</p>
<p style="text-align: justify;">
	Here&rsquo;s a 10-step process to delegate effectively:</p>
<p style="text-align: justify;">
	1.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Decide what it is you want to delegate</p>
<p style="text-align: justify;">
	2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Select the best person you can allocate the particular task to</p>
<p style="text-align: justify;">
	3.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ensure the chosen person is willing to take on this responsibility</p>
<p style="text-align: justify;">
	5.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Provide resources to achieve the extra job</p>
<p style="text-align: justify;">
	6.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Give additional training if needed</p>
<p style="text-align: justify;">
	7.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Set up a clear target date for full acceptance and the standard expected</p>
<p style="text-align: justify;">
	10.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Monitor progress, give support and recognition</p>
<p style="text-align: justify;">
	When this process is carefully followed, delegation can provide many benefits to the person performing the task. This is his or her opportunity to be stretched with additional support, get the chance to make bigger decisions which ultimately will boost his or her motivation because of the added responsibilities. Most busy managers miss out the step three and lose all the effectiveness of their delegation as a result.</p>
<p style="text-align: justify;">
...
<p style="text-align: justify;">
  ...
  $link = "http://localhost/nigerianseminars/download_article/77/".stripslashes("A_10-Step_Process_to_Delegate_Effectively.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/77/A_10-Step_Process_to_Delegate_Effectively.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/77/".str_replace($title_link,"-","A 10-Step Process to Delegate Effectively");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/77/".str_replace($title_link,"-","A 10-Step Process to Delegate Effectively");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Delegation, Responsibilities, Skill, Managers, Authority, Decisions, Motivation, Resources.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
