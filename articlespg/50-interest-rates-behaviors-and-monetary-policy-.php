...
<head>
  ...
  <title><?php echo substr(trim("Interest Rates Behaviors and Monetary Policy Response"), 0, 65);?></title>
  <meta name="description" content="
	A stable deposit base as opposed to volatile, short-term funds has started to impact positively on interest rates stability. In - 50"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Interest Rates Behaviors and Monetary Policy Response</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=50" title="Authors Page">
  ...
  $link = "http://localhost/nigerianseminars/download_article/50/".stripslashes("Interest_rates_behaviors_and_monetary_policy_response.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/50/Interest_rates_behaviors_and_monetary_policy_response.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/50/".str_replace($title_link,"-","Interest Rates Behaviors and Monetary Policy Response");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/50/".str_replace($title_link,"-","Interest Rates Behaviors and Monetary Policy Response");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Interest, Rates, Stability, Deposit, Lending, Facility.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
