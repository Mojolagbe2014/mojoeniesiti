...
<head>
  ...
  <title><?php echo substr(trim("Gain Report - Nigeria: Crop update"), 0, 65);?></title>
  <meta name="description" content="
	Report Highlights: Nigeria&#39;s grain production this year is up slightly from the average crop of 2010. Farmers increased average - 31"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Gain Report - Nigeria: Crop update</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=31" title="Authors Page">
  ...
  <tr>
	...
	Report Highlights: Nigeria&#39;s grain production this year is up slightly from the average crop of 2010. Farmers increased average and rainfall patterns were near ideal for the growing season. The arrival of the new crop in the market has not brought any respite to poultry producers as grain prices have remained firm because of limited supplies. Except for sorghum, the harvest of most grains has been completed in Nigeria. FAS/Lagos visited Nigeria&rsquo;s grain belt (Kaduna, Zaria, and Abuja) in mid-October to assess the crop situation.</p>
<p style="text-align: justify;">
	Larger Grain Harvests</p>
<p style="text-align: justify;">
	Preliminary findings from the annual agricultural performance survey, conducted by NAERLS</div><br /><br />
  <div>
...
&amp; Michael David, agricultural specialist</div></div>
  ...
  $link = "http://localhost/nigerianseminars/download_article/31/".stripslashes("Update_Lagos_Nigeria_12-7-2011.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/31/Update_Lagos_Nigeria_12-7-2011.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/31/".str_replace($title_link,"-","Gain Report - Nigeria: Crop update");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/31/".str_replace($title_link,"-","Gain Report - Nigeria: Crop update");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Grain, Production, Harvest, Prices, Ban, Fertilizer, Growth, Agriculture, Subsidy.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
