...
<html lang="en">
<head>
  <meta property="og:image" content="http://localhost/nigerianseminars/nstlogin/articles_images/TAtToubISNNUXSZw9kIL157693e871eac9a65752710729919c00.JPG"/>
  ...
  <title><?php echo substr(trim("Welcome to the World of Leadership!"), 0, 65);?></title>
  <meta name="description" content="
	New managers soon get the idea that sainthood would be easier than being a good leader. Making the transition from the frontline - 74"/>
...
<body>
  ...
  <div class="imageFloat"><img src="http://localhost/nigerianseminars/nstlogin/articles_images/TAtToubISNNUXSZw9kIL157693e871eac9a65752710729919c00.JPG" width="100" height="100" alt="nigerianseminarsand trainings" class="articleImg shadow"/></div>
  </td>
  <td style="text-align:center;">
  <h1 style="font-size:23px; text-align:center;">Welcome to the World of Leadership!</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=74" title="Authors Page">
  ...
  <tr>
	...
	New managers soon get the idea that sainthood would be easier than being a good leader. Making the transition from the frontline to management is one of the trickiest moves that anyone has to make. You immediately face various dilemmas, as a new member of the leadership fraternity: how do you leave your colleagues behind, but make sure that they follow your lead?</p>
<p style="text-align: justify;">
	You may have been the joker before, but how are you going to become the sober minded manager who will be setting the objectives for the team? How can you ensure that the work is achieved to a good standard, whilst developing people to a point where they do not need you to be there to do the work? How do you make sure that you don&rsquo;t get insecure?</p>
<p style="text-align: justify;">
	Part of the job description is that you are required to be creative or to recognize people, who have this talent, listen to them and even act upon their ideas. You also need to be practical, plan ahead, ensure that all risks are known and be aware of the details whilst looking at the &ldquo;BIG PICTURE!&rdquo; Take risks, but ensure the future wellbeing of the firm.</p>
<p style="text-align: justify;">
	Above all else, make sure next month&rsquo;s results are better than last months&rsquo; and do this EVERY month? In addition to the previous requirement, you will not only get along with the people in your charge, you will develop enough energy for unstoppable team effort. In short, you will need to develop a range of skill set to be on the top of your role. Welcome to the world of leadership!</p>
<p style="text-align: justify;">
...
<p>
  ...
  $link = "http://localhost/nigerianseminars/download_article/74/".stripslashes("Welcome_to_the_World_of_Leadership.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/74/Welcome_to_the_World_of_Leadership.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/74/".str_replace($title_link,"-","Welcome to the World of Leadership!");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/74/".str_replace($title_link,"-","Welcome to the World of Leadership!");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Management, Manager, Standard, Job, Description, Skill, Leadership.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
