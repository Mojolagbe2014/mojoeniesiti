...
<head>
  ...
  <title><?php echo substr(trim("What is the Bank Lending Channel of Monetary Policy Transmission?"), 0, 65);?></title>
  <meta name="description" content="
	The mechanism by which monetary policy is transmitted to the real economy remains a central topic in macroeconomics. The bank lending - 53"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">What is the Bank Lending Channel of Monetary Policy Transmission?</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=53" title="Authors Page">
...
<p style="text-align: justify;">
  ...
  $link = "http://localhost/nigerianseminars/download_article/53/".stripslashes("bank_lending_channel_of_monetary_policy_transmission.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/53/bank_lending_channel_of_monetary_policy_transmission.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/53/".str_replace($title_link,"-","What is the Bank Lending Channel of Monetary Policy Transmission?");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/53/".str_replace($title_link,"-","What is the Bank Lending Channel of Monetary Policy Transmission?");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Monetary, Policy, Macroeconomics, Credit, Deposits, Reserves, Loan, Stock, Bond.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
