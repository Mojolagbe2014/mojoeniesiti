...
<head>
  ...
  <title><?php echo substr(trim("Art of the start - Everyone should carefully observe which way his heart draws him, and then choose that way with all his strength"), 0, 65);?></title>
  <meta name="description" content="
	I use a top-ten list format for all my speeches, and I would love to begin this book with a top-ten list of the most important things - 13"/>
...
<body>
  ...
  <h1 style="font-size:23px; text-align:center;">Art of the start - Everyone should carefully observe which way his heart draws him, and then choose that way with all his strength</h1>
  <br />
  <div class="event_provider">
  <a href="http://localhost/nigerianseminars/authorPage?id=13" title="Authors Page">
  <p style="color:#fff;"> Author:&nbsp;&nbsp;Guy Kawasaki </p>
  </a>
  </div>
  <!--social media-->
  <!--end social media-->
  ...
  <tr>
	...
	I use a top-ten list format for all my speeches, and I would love to begin this book with a top-ten list of the most important things an entrepreneur must accomplish. However, there aren&#39;t ten there are only five,</p>
<p>
	Great Ideas for Starting Things</p>
<p>
	1 MAKE MEANING. The best reason to start an organization is to make meaning&mdash;to create a product or service that makes the world a better place. So your first task is to decide how you can make meaning.</p>
<p>
	2 MAKE MANTRA. Forget mission statements; they are long, boring, and irrelevant. No one can ever remember them&mdash;much less implement them. Instead, take your meaning and make a mantra out of it. This will set your entire team on the right course.</p>
<p>
	3 GET GOING. Start creating and delivering your product or service. Think soldering irons, compilers, hammers, saws, and AutoCAD&mdash;whatever tools you use to build products and services. Do not focus on pitching, writing, and planning.</p>
<p>
	4 DEFINE YOUR BUSINESS MODEL. No matter what kind of organization you are starting, you have to figure out a way to make money. The greatest idea, technology, product, or service is short-lived without a sustainable business model.</p>
<p>
	5 WEAVE A MAT (MILESTONES, ASSUMPTIONS, AND TASKS). The final step is to compile three lists: (a) major milestones you need to meet; (b) assumptions that are built into your business model; and (c) tasks you need to accomplish to create an organization. This will enforce discipline and keep your organization on track when all hell breaks loose&mdash;and all hell will break loose....</p>
<p>
	&nbsp;</p>
<p>
	Guy Kawasaki</p>
  ...
  <div>
      <div class="articleaboutAuthor"><h2 style="font-size:13px;">About the Author - <span style="color:#000;font-weight: bold">Guy Kawasaki</span></h2></div><br />
  <div> 
  <div >
      <div style=" width:100%"><div style="text-align:justify;  font-size:12px">Guy Kawasaki is CEO of http://garage.com, a Silicon Valley based firm that assists high-technology start-ups find start-up capital using the Internet. Prior to this position, Kawasaki was an Apple Fellow at Apple Computer, Inc. A noted<br />
Columnist (Forbes), speaker, and founder of various personal computer companies, Kawasaki was one of the individuals responsible for the success of the Macintosh computer. Kawasaki is the author of seven books:<br />
The Macintosh Way, Database 101, the Computer Curmudgeon, How to Drive Your Competition Crazy, Hindsight, and Selling the Dream. His<br />
Most recent book is called Rules for Revolutionaries, published in January. 1999.</div></div>
  </div>
  </div>
  </div>
  ...
  <a href="http://localhost/nigerianseminars/author/Guy-Kawasaki" class="cssButton_roundedLow cssButton_aqua" style="padding:6px; font-size:12px; background-color:#435A65; color:#FFF;" title="More articles by Guy Kawasaki" > More articles by Guy Kawasaki</a>
  </td>
  ...
  $link = "http://localhost/nigerianseminars/download_article/13/".stripslashes("1.01.ArtOfTheStart.pdf");
  $name = '';
  $ArticleUrl = "";
  }
  else{
  $link = '#Login_pop';
  $name = 'prompt';
  $ArticleUrl = "http://localhost/nigerianseminars/download_article/13/1.01.ArtOfTheStart.pdf";
  }
  ?>
  ...
  <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/13/".str_replace($title_link,"-","Art of the start - Everyone should carefully observe which way his heart draws him, and then choose that way with all his strength");?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
  <div class="fb-share-button" data-href="https://www.nigerianseminarsandtrainings.com/<?php echo "article/full/13/".str_replace($title_link,"-","Art of the start - Everyone should carefully observe which way his heart draws him, and then choose that way with all his strength");?>" data-type="button_count"></div>
  ...
  <p> 
  <span>
  <strong style="float:left; margin-right:8px;">Tags: </strong> <?php echo tags("Entrepreneur, Product, Service, Model, Business, Ideas.",'articletagsearch');?>
  </span>
  </p>
  <div class="clearfix"></div>
  </div>
  ...
  <strong style="color:#006600;">Contact Guy Kawasaki</strong>
