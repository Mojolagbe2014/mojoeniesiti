...
$offset = ($pagenum - 1) * $recordperpage;
 if(isset($val) && isset($urlSate) ){
    ...
    $query = " AND state=25 AND SortDate >= '$today' AND ( $lagSubDivParam ) ";
...
//    $pastLink = '?l='.$thisLagRegion.'&amp;st='.$rowStateDivs['id'];
...
var divId = "<?php echo $lagSubDivParam2; ?>";
$.ajax({
url:'<?php echo SITE_URL;?>tools/LoadEvents.php',
data:'month='+val+'&state='+stateId+'&stateMainDivision='+divId,
beforeSend: function(){
Preloader()
},
