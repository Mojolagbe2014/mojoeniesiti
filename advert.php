...
<tr>
<td style="padding-left:8px"><h1 style="font-size:28px;font-weight: normal;padding:5px;"><i class="fa fa-flag"></i>&nbsp;Advertise with us</h1></td>
</tr>
<tr>
...
<div class="highlights"><h2 style="font-size:22px; font-weight:normal;">Advert Formats and Rates</h2></div>
<div class="pricing two green_tab">
<!--price box column-->
<div class="price-col first">
<div class="th">
<h3 style="font-size:12px;"><span class="title"><strong>Advert Sizes in </strong>(pixel)</span></h3>
...
<li class="odd ad-size">200 X 200</li> 
...
<div class="th">
<h3 style="font-size:12px;"><span class="title"><strong>Prices / Month (VAT Inclusive)</strong></span></h3>
<span class="bottom"></span>
</div>
<div class="p-inner">
<ul class="feature" style="list-style:none;">
<li> NGN 312,375 
  <a href="#currency" class="currency" onclick="GetRate('NGN 312,375')" style="padding-left:30px;">Convert</a>
  <form action="paypal/order-process.php" method="POST">
    <input type="hidden" name="amount" value="<?php echo $converter->convert(312375, 'NGN', 'USD'); ?>"/>
    <input type="hidden" name="item_id" value="100"/>
    <input type="hidden" name="item_name" value="120 x 600 ad size"/>
    <a href="#myModal1" name="modal" class="inter-switch-btn" style="font-size:12px;">
      <img src="images/interswitch_ch.png" alt="payment method">
    </a>
    <button type="submit" class="paypal-btn">
        <input type="image" class="paypal_img" src="http://www.nigerianseminarsandtrainings.com/images/subscribe-btn.png" name="submit" alt="PayPal – The safer, 
      easier way to pay online.">
    </button>
  </form>
</li>
<li class="odd">NGN 312,375
  <a href="#currency" class="currency" onclick="GetRate('NGN 312,375')" style="padding-left:30px;">Convert</a>
  <form action="paypal/order-process.php" method="POST">
    <input type="hidden" name="amount" value="<?php echo $converter->convert(312375, 'NGN', 'USD'); ?>"/>
    <input type="hidden" name="item_id" value="101"/>
    <input type="hidden" name="item_name" value="160 X 600 ad size"/>
    <a href="#myModal1" name="modal" class="inter-switch-btn" style="font-size:12px;">
      <img src="images/interswitch_ch.png" alt="payment method">
    </a>
    <button type="submit" class="paypal-btn">
...
<li>NGN 183,750 
  <a href="#currency" class="currency" onclick="GetRate('NGN 183,750')" style="padding-left:30px;">Convert</a>
  <form action="paypal/order-process.php" method="POST">
    <input type="hidden" name="amount" value="<?php echo $converter->convert(183750, 'NGN', 'USD'); ?>"/>
    <input type="hidden" name="item_id" value="102"/>
    <input type="hidden" name="item_name" value="468 x 60 ad size"/>
    <a href="#myModal2" name="modal" class="inter-switch-btn" style="font-size:12px;">
      <img src="images/interswitch_ch.png" alt="payment method">
    </a>
    <button type="submit" class="paypal-btn">
        <input type="image" class="paypal_img" src="http://www.nigerianseminarsandtrainings.com/images/subscribe-btn.png" name="submit" alt="PayPal – The safer, 
...
<li class="odd">NGN 312,375 
  ...
  <form action="paypal/order-process.php" method="POST">
    ...
    <input type="hidden" name="item_name" value="728 X 90 ad size"/>
    <a href="#myModal1" name="modal" class="inter-switch-btn" style="font-size:12px;">
      <img src="images/interswitch_ch.png" alt="payment method">
    </a>
    <button type="submit" class="paypal-btn">
...
<li>NGN 128,625 
  <a href="#currency" class="currency" onclick="GetRate('NGN 128,625')" style="padding-left:30px;">Convert</a>
  <form action="paypal/order-process.php" method="POST">
    <input type="hidden" name="amount" value="<?php echo $converter->convert(128625, 'NGN', 'USD'); ?>"/>
    <input type="hidden" name="item_id" value="104"/>
    <input type="hidden" name="item_name" value="234 X 90 ad size"/>
    <a href="#myModal3" name="modal" class="inter-switch-btn" style="font-size:12px;">
      <img src="images/interswitch_ch.png" alt="payment method">
    </a>
  <button type="submit" class="paypal-btn">
      <input type="image" class="paypal_img" src="http://www.nigerianseminarsandtrainings.com/images/subscribe-btn.png" name="submit" alt="PayPal – The safer, 
...
<li>NGN 220,500 
  <a href="#currency" class="currency" onclick="GetRate('NGN 220,500')" style="padding-left:30px;">Convert</a>
  <form action="paypal/order-process.php" method="POST">
      <input type="hidden" name="amount" value="<?php echo $converter->convert(220500, 'NGN', 'USD'); ?>"/>
      <input type="hidden" name="item_id" value="106"/>
      <input type="hidden" name="item_name" value="300 X 250 ad size"/>
      <a href="#myModal4" name="modal" class="inter-switch-btn" style="font-size:12px;">
        <img src="images/interswitch_ch.png" alt="payment method">
      </a>
      <button type="submit" class="paypal-btn">
        <input type="image" class="paypal_img" src="http://www.nigerianseminarsandtrainings.com/images/subscribe-btn.png" name="submit" alt="PayPal – The safer, 
...
<li class="odd">NGN 275,625 
  <a href="#currency" class="currency" onclick="GetRate('NGN 275,625')" style="padding-left:30px;">Convert</a>
  <form action="paypal/order-process.php" method="POST">
    <input type="hidden" name="amount" value="<?php echo $converter->convert(275625, 'NGN', 'USD'); ?>"/>
    <input type="hidden" name="item_id" value="107"/>
    <input type="hidden" name="item_name" value="200 X 200 ad size"/>
    <a href="#myModal5" name="modal" class="inter-switch-btn" style="font-size:12px;">
      <img src="images/interswitch_ch.png" alt="payment method">
    </a>
    <button type="submit" class="paypal-btn">
        <input type="image" class="paypal_img" src="http://www.nigerianseminarsandtrainings.com/images/subscribe-btn.png" name="submit" alt="PayPal – The safer, 
...
<li>NGN 183,750 
  ...
  <form action="paypal/order-process.php" method="POST">
    ...
    <input type="hidden" name="item_name" value="250 X 400 ad size"/>
    <a href="#myModal2" name="modal" class="inter-switch-btn" style="font-size:12px;">
      <img src="images/interswitch_ch.png" alt="payment method">
    </a>
    <button type="submit" class="paypal-btn">
        ...
        <tr>
          <td>  
            <label class="field prepend-icon">
                <input type="text" name="name" id="name" class="gui-input" placeholder="Full Name" required>
          ...
          <td> 
            <label class="field prepend-icon">
                ...
                <span class="input-hint"> 
                  <strong>Note: </strong>By clicking Continue, you agree that you are about to pay the sum of N312375.</span>   
            </label>
          </td>
        <tr>
        <input type="hidden" name="amount" value="31237500">  
        ...
        <tr>
          <td> 
            <label class="field prepend-icon">
                ...
                <label for="comment" class="field-icon"><i class="fa fa-comments"></i></label>
                <span class="input-hint"> 
                  <strong>Note: </strong>By clicking Continue, you agree that you are about to pay the sum of N183750 .</span>   
            </label>
          </td>
        <tr>
        <input type="hidden" name="amount" value="18375000"> 
        <td colspan="2" align="center" >
          <button class="button btn-primary" type="submit"> Continue </button>
          <input name="to" type="hidden" value="" id="to" />
          <input name="course" type="hidden" value="" id="course" /> 
          <span class="button" id="closeBox"> Close </span>
        </td>
        </tr>
    </table> 
  </form>
...
<!-- Modal3 -->
<div id="myModal3" style="float:left;" class="window boxContent"> 
  <form id="formProvider" name="form1" method="post" action="" class="smart-forms form_content" >
      <table class="contact_provider_table">
        <tr>
          <td>  
        ...
        <tr>
          <td> 
            <label class="field prepend-icon">
                ...
                <label for="comment" class="field-icon"><i class="fa fa-comments"></i></label>
                <span class="input-hint"> 
                  <strong>Note: </strong>By clicking Continue, you agree that you are about to pay the sum of N128625 .</span>   
            </label>
          </td>
        <tr>
        <input type="hidden" name="amount" value="12862500">
        <td colspan="2" align="center" >
          <button class="button btn-primary" type="submit"> Continue  </button>
          <input name="to" type="hidden" value="" id="to" />
          <input name="course" type="hidden" value="" id="course" /> 
          <button class="button" id="closeBox" onclick=""> Close </button>
        </td>
        </tr>
    </table> 
  </form>
...
<!-- Modal4 -->
<div id="myModal4" style="float:left;" class="window boxContent"> 
  <form id="formProvider" name="form1" method="post" action="" class="smart-forms form_content" >
      <table class="contact_provider_table">
        <tr>
          <td>  
...
<!-- Modal5 -->
<div id="myModal5" style="float:left;" class="window boxContent"> 
  <form id="formProvider" name="form1" method="post" action="" class="smart-forms form_content" >
      <table class="contact_provider_table">
        <tr>
          <td>  
        ...
        <tr>
          <td> 
            <label class="field prepend-icon">
                ...
                <label for="comment" class="field-icon"><i class="fa fa-comments"></i></label>
                <span class="input-hint"> 
                  <strong>Note: </strong>By clicking Continue, you agree that you are about to pay the sum of N275625.</span>   
            </label>
          </td>
        <tr>
        <input type="hidden" name="amount" value="27562500"> 
        <td colspan="2" align="center" >
          <button class="button btn-primary" type="submit"> Continue  </button>
          <input name="to" type="hidden" value="" id="to" />
          <input name="course" type="hidden" value="" id="course" /> 
