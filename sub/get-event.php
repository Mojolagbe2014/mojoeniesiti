...
?>
<div class="testCalendar" id="cal-<?php echo $rows['event_id'];?>">
    ...
    <ul>
       ...
       <!-- <li><i class="icon-times"></i> <a href="javascript:void(0)" style="color:#FF0000;" onclick="Delete(<?php echo $rows['event_id'];?>)">Delete from calendar</a></li>-->
