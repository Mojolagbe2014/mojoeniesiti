...
$errors = array();
	...
	$result = MysqlSelectQuery("select password from subscribers where subscriber_id='".$_SESSION['user_id']."'");
	...
	if(MysqlQuery("update subscribers set password='$hashP' where subscriber_id='".$_SESSION['user_id']."'"))
	{
