...
$url ="";
	...
	$truePattern = SITE_URL.'events/'.$rows['event_id'].'/'.str_replace($title_link,"-",$rows['event_title']);
...
function tags($tag){
	...
	for($i = 0; $i <  sizeof($getTags); $i++){
		$link .= '<a href="'.SITE_URL.'all_event_tag_search?tag='.ucfirst(str_replace(" ","",$getTags[$i])).'" style="font-size:12px;text-decoration:underline; font-weight:normal;color:#060;" >'.ucfirst($getTags[$i]).'</a> ';
			
	}
	return $link;
	}
}
$description = substr(strip_tags(stripslashes(str_replace('"',"'",$rows['description']))),0,130)."(EVID:".$rows['event_id'].")";
?>
...
<?php
  ...
  <tr>
    ...
    <td colspan="4" valign="middle" style="font-size:20px; color:#090; line-height:20px; padding-bottom:7px"><p style="display:block; margin-top:20px;"><?php echo $rows['event_title'];?></p><br/><br /><br />
...
<script type="text/javascript">
  (function() {
    ...
    <td width="21%" colspan="2" align="center" style="font-size:17px; color:#0072BC; padding-bottom:7px"><strong style="margin-bottom:5px; display:block;"><span style="color:#0072BC; font-size:12px">Watch Preview</span></strong><?php if( $rows['videoID'] == ''){;?>
  ...
  <tr>
    <td width="14%" rowspan="5" style="font-size:16px; color:#0072BC; padding-bottom:7px"><?php echo $logo;?></td>

    <td width="18%"><strong><span style="color:#0072BC; font-size:13px">Provider:</span></strong></td>

    <td colspan="4"><span style="color:#090; font-size:14px;"><strong><strong><?php echo $rows['organiser'];?></strong></strong></span></td>
    </tr>

  <tr>
    <td><strong><span style="color:#0072BC; font-size:13px">Duration:</span></strong></td>


    <td colspan="4"><span style="color:#666; font-size:13px"><?php echo dateDiff($rows['startDate'], $rows['endDate']);?></span></td>
    </tr>

  <tr>
    <td valign="top"><strong><span style="color:#0072BC; font-size:13px"><span style="color:#666;font-size:12px"><span style="color:#666; font-size:12px"><span style="color:#0072BC; font-size:12px"><strong>Date:</strong></span></span></span></span></strong></td>

    <td colspan="4" valign="top" style="color:#666;font-size:13px"><span style="font-size:13px"><span style="font-size:13px"><?php echo $rows['startDate'];?> <strong style="color:#666">to</strong> <?php echo $rows['endDate'];?></span></span></td>
    </tr>
    

  <tr>

    <td><strong><span style="color:#0072BC; font-size:13px">Venue:</span></strong></td>

    <td colspan="4" style="color:#666;font-size:13px"><?php echo $rows['venue'];?></td>
    </tr>
  <tr>
    <td><strong><span style="font-size: 13px; color:#0072BC;">Attendance  Fee:</span></strong></td>
    <td colspan="4" style="font-size:13px"><span style="color:#666;font-size:13px"><?php echo $rows['cost'];?></span></td>
  </tr>

  <tr>

    <td>&nbsp;</td>
    <td><span style="color:#666;font-size:12px"><span style="color:#666; font-size:13px"><span style="color:#0072BC; font-size:13px"><strong>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><span style="color:#666;font-size:12px"><span style="color:#666; font-size:13px"><span style="color:#0072BC; font-size:13px"><strong>
    Category:</strong></span></span></span></td>
    <td colspan="4"><span style="color:#666;font-size:12px"><span style="color:#666; font-size:13px"><span style="color:#0072BC; font-size:13px"><strong><span style="font-size:13px"><strong><span style="color:#666;font-size:13px"><strong><?php echo $rows_cat['category_name'];?></strong></span></strong></span></strong></span></span></span></td>
    </tr>
  <tr>

    <td colspan="6"><span style="color:#0072BC; font-size:13px"><strong>Event Description:</strong></span></td>
    </tr>
  ...
  <tr bgcolor="#F7F7F7">
   ...
   <tr>
     <td colspan="6" style="color:#666;"><span style="color:#0072BC; font-size:12px"><strong>Facilitator(s):</strong></span></td>
     </tr>
 
   <tr>
     <td colspan="6" style="color:#666;"><div class="description" style="font-size:13px; text-align:justify;"><?php echo $rows['facilitator'];?></div></td>
   </tr>
   <tr>

    <td colspan="6" align="right" style="color:#666;"> 
      <?php if(($rows['premium'] > 0) && ($rows['premium'] !=8) ){ if($rows['website'] != ''){?><a href="<?php echo $url;?>" target="_blank" onclick="GetWebClicks('<?php echo $rows['organiser'];?>')"><img src="<?php echo SITE_URL;?>images/link_btn.png" alt="Nigerian Seminars and Trainings Visit Site"/></a><?php }}?>      <a href="javascript:void(0);" onclick="ShowBox()" ><img src="<?php echo SITE_URL;?>images/contact_btn.png" width="132" height="28" /></a>    </td>
 ...
 <tr>
    <td width="112" style="color:#666;"><span style="color:#0072BC; font-size:12px"><strong><?php if($rows['tags']==""){ echo "";} else{?>Tags:<?php }?></strong></span></td>
    <td width="595" colspan="5" style="color:#666;"><?php echo tags($rows['tags']);?></td>
    </tr>
</table>

<div id="contact-wrapper2" class="rounded"> 
