...
<meta name="author" content="Nigerian Seminars and Trainings" />
...
<meta name="dcterms.contributor" content="Nigerian Seminars and Trainings" />
<meta name="dcterms.creator" content="Nigerian Seminars and Trainings" />
 ...
 <ul class="orion-menu petrol">
      ...
      <li><a href="<?php echo SITE_URL;?>contact-us" rel="nofollow">Contact Us</a></li>
				...
				<li class="social hidele">
					...
					<a href="https://plus.google.com/+Nigerianseminarsandtrainings" target="_blank" style="background:none" ><i class="fa fa-google" ></i><span class="tooltip">Google Plus</span></a>
...
<div class="clearfix"></div>
          ...
          <?php //include("../tools/search_box.php");?>
                    ...
                    <div class="description roundborder" style="font-size:13px; text-align:justify; ">
                   
                      <p style="line-height:20px; color:#000000;"><strong style="font-size:16px">Welcome</strong> to Nigerian Seminars and Trainings</p>
                    ...
                    <strong>Events Highlights</strong>
                     <p style="color:#333; font-size:12px; font-weight:normal;">Browse through this list to search for, book and attend seminars, conferences, workshops and training in Nigeria, Africa, Asia, North / South America and Europe</p>
                    </div>
	...
	if(NUM_ROWS($result_pre) > 0){
					while($rows_pre = SqlArrays($result_pre)){
                       ...
                       <div itemscope itemtype="http://schema.org/EducationEvent" class="eventListing vevent" onClick="javascript:url_location('<?php echo SITE_URL.'events/'.$rows_pre['event_id'].'/'.str_replace($title_link,"-",$rows_pre['event_title']);?>')">
                       
                      <a href="<?php echo SITE_URL.'../events'.$rows_pre['event_id'].'/'.str_replace($title_link,"-",$rows_pre['event_title']);?>" itemprop="url" style="background-color:#E3EBEE; display:block; padding:3px;" ><h2 style="font-size:16px;"> <span class="spanTitle summary" itemprop="name"><?php echo $rows_pre['event_title'];?></span></h2></a>
                      
                      <div class="innerHeadingPropEvent">
     <p itemprop="duration"><?php echo dateDiff($rows_pre['startDate'], $rows_pre['endDate']);?> &nbsp;&nbsp; | &nbsp;&nbsp; </p>
                       
                
                       <p itemprop="doorTime"><?php echo date('M d',strtotime($rows_pre['startDate']))." - ".date('d M, Y',strtotime($rows_pre['endDate']));?> &nbsp;&nbsp; | &nbsp;&nbsp; </p>
                         <span style="display:none;" itemprop="startDate" class="dtstart" content="<?php echo date('Y-m-d h:m:s',strtotime($rows_pre['startDate']));?>"><?php echo date('Y-m-d h:m:s',strtotime($rows_pre['startDate']));?></span>
                         
                      
                       
                       <p itemprop="location"><?php echo GetEventLocation($rows_pre['event_id']);?></p>
                       </div>
                      ...
                      <!-- <span class="provider">Provider:</span>--><h2 style="font-size:12px;">
                        ...
                        <span style="color:#000;" itemprop="description" class="description" ><?php echo substr(stripslashes(strip_tags($rows_pre['description'])),0,200).'...';?> <em style="color:#F00;"><img src="<?php echo SITE_URL;?>images/viewbutton.png" width="77" height="18" alt="view more" style="vertical-align:middle; float:right; border:none; background:none;"></em></span>
                        </span>
                      </h2>
                       </div> 
...
<?php include("../tools/category_new_responsive.php");?>
      ...
      <!--quarterly guide-->
		...
		while($rows = SqlArrays($result)){
			...
			$link = '#Login_pop';
			$name = 'class="prompt"';
			$url = SITE_URL.'QuarterlyGuide/'.str_replace(" ","_",$rows['name']).'_Conferences_and_Training_Guide.pdf';
			}
		?>
       <li><a href="<?php echo $link ;?>" <?php echo $name ;?> target="_blank" rel="nofollow" onClick="GetAction('<?php echo $url ;?>')" ><?php echo $rows['name'];?> Conferences and Training Guide</a></li>
       <?php
		}
		?>
...
<script type="text/javascript">
  ...
  <div class="slideshow" style="text-align:center;">
    ...
    <div class="button_class">Read Articles</div>
         ...
         <ul>
            ...
            <span style="display:block;padding:0 5px 0 5px; font-weight:bold;"><a href="<?php echo SITE_URL;?>quoteArchive" rel="nofollow" >...more quotes </a></span>
             </div>
  ...
  <div class="divider"></div><br />
    <div style="text-align:center;"><a href="<?php echo SITE_URL;?>weather" rel="nofollow" ><img src="<?php echo SITE_URL;?>images/weather_logo_large.gif" width="300" height="90" alt="nigerian seminars and trainings" /></a></div>        <br /><br />
...
<div class="socialInner facebook">
 <div class="fb-like" data-href="https://www.nigerianseminarsandtrainings.com" data-layout="standard" data-action="like" data-show-faces="false" data-share="true" ></div>
</div>
...
<div style="width:55%; margin-right:auto; margin-left:auto;">
