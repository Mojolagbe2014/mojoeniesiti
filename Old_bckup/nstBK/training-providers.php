...
<table >
  ...
  <tr>
    <td style="padding-left:8px;"><p style="font-size:25px; padding:5px;">Training providers in Nigeria and around the world</p></td>
    </tr>
  <tr>
		...
		while($rows = SqlArrays($result)){
			...
			switch($rows['premium']){
				case 3:
                            ...
                            <a href="<?php echo SITE_URL;?>tprovider/<?php echo $rows['business_id'].'/'.str_replace($title_link,"-",$rows['business_name']);?>" > <span class="spanTitle" style="background-color:#E3EBEE; display:block; padding:3px;" itemprop="name"><?php echo $rows['business_name'];?></span></a>
...
$num = NUM_ROWS($result);
		...
		while($rowsNonPremium = SqlArrays($resultNonPremium)){
			...
			?>
                           ...
                           <a href="<?php echo SITE_URL;?>tprovider/<?php echo $rowsNonPremium['business_id'].'/'.str_replace($title_link,"-",$rowsNonPremium['business_name']);?>" > <span class="spanTitle" style="background-color:#E3EBEE; display:block; padding:3px;" itemprop="name"><?php echo $rowsNonPremium['business_name'];?></span>
                            </a>
                       <div class="trainingProviders">
                       <span class="span" itemprop="description"><?php echo substr(strip_tags(stripslashes($rowsNonPremium['description'])),0,160)."...";?></span>
                        ...
                        <div class="trainingProviders">
                       <span class="provider">Contact</span>
                        <span class="provider_name"><span style="color:#000" itemprop="address"><?php echo $rowsNonPremium['address'];?></span></span>
