...
<link href="<?php echo SITE_URL;?>images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
	<title>Articles by <?php echo $rowName['author']; if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?> - Nigerian Seminars and Trainings</title>

<meta name="description" content="Search, find and download professional, academic and general purpose articles by <?php echo $rowName['author'];?> on Nigerian Seminars and Trainings<?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>"/>

<meta name="keywords" content="articles, write-ups, journals, reports, educational reprots, reports about Nigeira" />

<meta name="dcterms.description" content="Search, find and download professional, academic and general purpose articles by <?php echo $rowName['author'];?> on Nigerian Seminars and Trainings<?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />

<meta property="og:title" content="Articles by <?php echo $rowName['author']; if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?> - Nigerian Seminars and Trainings" />

<meta property="og:description" content="Search, find and download professional, academic and general purpose articles by <?php echo $rowName['author'];?> on Nigerian Seminars and Trainings<?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />

<meta property="twitter:title" content="Articles by <?php echo $rowName['author']; if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?> - Nigerian Seminars and Trainings" />

<meta property="twitter:description" content="Search, find and download professional, academic and general purpose articles by <?php echo $rowName['author'];?> on Nigerian Seminars and Trainings<?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />
  ...
  <tr>
    <td style="font-size:11px">&nbsp;</td>
                ...
                <!-- <div class="highlights">
                    <strong>View Latest Articles</strong></div>-->
  ...
  $i++;
   ...
   if(connection()){
       ...
       <?php
                     ...
                     Paging("SELECT COUNT(article_id) AS numrows FROM articles where status=1 and author like '%".$author."%' ",$recordperpage,$pagenum,SITE_URL."articles?get");
                     ?>
                     </div>
                      <div id="paging2">
       <?php

                     PagingMobile("SELECT COUNT(article_id) AS numrows FROM articles where status=1 and author like '%".$author."%' ",$recordperpage,$pagenum,SITE_URL."articles?get");
                     ?>
                     </div>
<?php
   }
