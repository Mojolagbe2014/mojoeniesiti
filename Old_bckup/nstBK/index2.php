...
<div id="venuProviders">
      <!-- Loads Venue Providers Asynchronously -->
         ...
         <span class="span_cat ">Useful Web Tools</span>
         <ul>
...
<div class="clearfix"></div>
          ...
          <?php //include("tools/search_box.php");?>
                    ...
                    <div class="description roundborder" style="font-size:13px; text-align:justify; ">
                      ...
                      <h2 style="font-size:13px; font-weight:normal;">Nigerian seminars and trainings is the most comprehensive source of information on conferences, workshops, seminars, training and other learning opportunities in Nigeria. Our global reach extends to over one hundred and thirty three (133) countries with very strong presence in United States, United Kingdom, India, Indonesia, Netherlands, Liberia, Estonia, Kenya, Gambia and Brazil to mention a few. We provide easy, up-to-date and by-the-click access to information on upcoming conferences, seminars and training to intending trainees / conference attendees in the comfort of their living rooms/offices anywhere in the world. <a href="about">Read More</a></h2>
	...
	if(NUM_ROWS($result_pre) > 0){
					while($rows_pre = SqlArrays($result_pre)){
                      ...
                      <span class="spanTitle" style="text-align:center; font-size:14px; color:#000000; margin-top:10px" ><?php echo $rows_pre['organiser'];?></span>
     ...
     <p itemprop="duration"><?php echo dateDiff($rows_pre['startDate'], $rows_pre['endDate']);?> &nbsp;&nbsp; | &nbsp;&nbsp; </p>
                      ...
                      <!-- <span class="provider">Provider:</span>--><h2 style="font-size:12px;">
                        ...
                        <span style="color:#000;" itemprop="description" class="description" ><?php echo substr(stripslashes(strip_tags($rows_pre['description'])),0,200).'...';?> <em style="color:#F00;"><img src="images/viewbutton.png" width="77" height="18" alt="view more" style="vertical-align:middle; float:right; border:none; background:none;"></em></span>
                        </span>
                      </h2>
                       </div> 
...
<?php include("tools/category_new_responsive.php");?>
    ...
    <div class="button_class">Socialize with us</div>
      ...
      <ul>
            <li> <a href="https://twitter.com/nigerianseminar" class="twitter-follow-button" data-show-count="true" data-lang="en" >Follow @twitterapi</a></li>
  ...
  <div class="divider"></div><br />
   ...
   <div style="text-align:center;"> <div class="fb-recommendations" data-app-id="Recommendations on Nigerian Seminars and Trainings.com" data-site="nigerianseminarsandtrainings.com" data-action="likes, recommends" data-width="300" data-colorscheme="light" data-header="true"></div></div>  
         ...
         <div class="sneak_peak2">
          ...
          <div class="tags">
          <span style="max-height:900px; overflow:scroll;">
          <?php
      EventsTags();
