...
<div class="clearfix"></div>
	...
	if(NUM_ROWS($result_pre) > 0){
					while($rows_pre = SqlArrays($result_pre)){
                      ...
                      <a href="<?php echo SITE_URL.'events/'.$rows_pre['event_id'].'/'.str_replace($title_link,"-",$rows_pre['event_title']);?>" class="url" style="background-color:#E3EBEE; display:block; padding:3px;" ><h2 style="font-size:16px;"> <span class="spanTitle summary" ><?php echo $rows_pre['event_title'];?></span></h2></a>
     ...
     <p ><?php echo dateDiff($rows_pre['startDate'], $rows_pre['endDate']);?> &nbsp;&nbsp; | &nbsp;&nbsp; </p>
                       
                
                       <p ><?php echo date('M d',strtotime($rows_pre['startDate']))." - ".date('d M, Y',strtotime($rows_pre['endDate']));?> &nbsp;&nbsp; | &nbsp;&nbsp; </p>
                       ...
                       <p class="location"><?php echo GetEventLocation($rows_pre['event_id']);?></p>
                       </div>
                      ...
                      <!-- <span class="provider">Provider:</span>--><h2 style="font-size:12px;">
                        ...
                        <span style="color:#000;"  class="description" ><?php echo substr(stripslashes(strip_tags($rows_pre['description'])),0,200).'...';?> <em style="color:#F00;"><img src="images/viewbutton.png" width="77" height="18" alt="view more" style="vertical-align:middle; float:right; border:none; background:none;"></em></span>
                        </span>
                      </h2>
                       </div> 
...
<?php include("tools/category_new_responsive.php");?>
        ...
        <div class="respond">
<div class="social">
 <div class="sneak_peak2" style="margin-top:0px;">
...
<!--<div class="socialize">
   ...
   <div class="TopBottomMenu">
	<ul style="font-size:14px;">
		<li><a href="https://www.facebook.com/nigerianseminars" style="color:#003399;" ><i class="fa fa-facebook"></i></a></li>
		<li><a href="https://twitter.com/NigerianSeminar" style="color:#3CF;"><i class="fa fa-twitter" ></i></a></li>
		<li><a href="https://plus.google.com/+Nigerianseminarsandtrainings"><i class="fa fa-google" ></i></a></li>
		<li><a href="https://www.youtube.com/user/nigerianseminars" style="color:#F00;" ><i class="fa fa-youtube" ></i></a></li>
        <li><a href="https://www.pinterest.com/nigerianseminar" style="color:#F00;" ><i class="fa fa-pinterest" ></i></a></li>
		<li><a href="https://www.stumbleupon.com/stumbler/nigerianseminars"  style="color:#3CF;" ><i class="fa fa-stumbleupon" ></i></a></li>
	</ul>
</div>
</div>
