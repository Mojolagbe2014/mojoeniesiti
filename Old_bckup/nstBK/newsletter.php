...
<link href="<?php echo SITE_URL;?>images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
	<title><?php echo substr($rows['title'],0,69)." NWID:".$rows['news_art_ID'];?></title>
...
<div id="main">
    ...
    <?php include("tools/categories_new.php");?>
		<div id="content_left">
        <h3 class="categoryHeader">Newsletter</h3>
				<div id="sub_links">
  ...
  <tr>
    <td colspan="3"><span style="color:#090; font-size:11px"><strong>Posted: <a href="#" style="color:#666;"><?php echo time_ago($rows['date_posted']);?></a></strong></span></td>
...
<span class='st_email_large' displayText='Email'></span></td>
  ...
  <tr bgcolor="#F7F7F7">
    <td colspan="4"><div class="description"><?php echo stripslashes(str_replace("../images/",SITE_URL."images/",$rows['description']));?></div></td>
  </tr>
