...
<div class="category_content responsiveCategoryMain">
      ...
      <div class="clearfix"></div>
       ...
       <ul >
            ...
            <li><h2 style="font-size:12px; font-weight:normal;"><a href="<?php echo SITE_URL;?>category/internal-audit-and-fraud">Internal Audit, Fraud </a></h2></li>
            ...
            <li><a href="<?php echo SITE_URL;?>countries/nigeria">Events in Nigeria</a></li>
      <li><a href="<?php echo SITE_URL;?>events/countries" >Events by Countries</a></li>
       <li><a href="<?php echo SITE_URL;?>training-provider/countries/nigeria" >Training Providers in  Nigeria</a></li>
...
<p style="text-align:center; font-size:14px; color: #105773; margin:5px 0 5px 0;" ><?php echo $rows_pre['organiser'];?></p>
                        ...
                        <a class="cssButton_roundedLow cssButton_aqua" style="padding:6px; font-size:10px; background-color:#435A65; color:#FFF;">View More</a></div>
                       <div class="clearfix"></div>   
                       </div>
                       <?php
					}
...
<!--prompt for download-->
  <div id="Login_pop" style="float:left;" class="window_currency boxContent smart-forms">
      <div class="alert notification alert-error">You must be logged in to download this quarterly guide, <a href="login" rel="nofollow" >Click here</a> to login. <br /> Dont have an account? <a href="upload-business-info" rel="nofollow">Click here</a>to register as a business or <a href="subscribers" rel="nofollow" >Click here</a> to register as a subscriber</div>
      <br />
      </div>
     <!-- end prompt-->
