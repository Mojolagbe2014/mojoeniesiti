...
<link href="<?php echo SITE_URL;?>images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
	...
	<title>Health and HSE - Nigerian Seminars and Trainings <?php echo $pg;?></title>

<meta name="description" content="Health safety and environment (HSE) | occupational health and safety seminars, courses, training in Nigeria, Africa, Asia, North / South America, Europe<?php echo $pg;?>"/>
