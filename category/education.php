...
<link href="<?php echo SITE_URL;?>images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
	...
	<title>Education - Nigerian Seminars and Trainings <?php echo $pg;?></title>

<meta name="description" content="Conferences, seminars, courses, training in Education | teacher training in Nigeria | education in Nigeria, Africa, Asia, North / South America, Europe <?php echo $pg;?>"/>
