...
<link href="<?php echo SITE_URL;?>images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
	...
	<title>Operations Management - Nigerian Seminars and Trainings <?php echo $pg;?></title>

<meta name="description" content="Operations | quality management |QM conferences, seminars, courses, workshops and training in Nigeria, Africa, Asia, Europe, North / South America <?php echo $pg;?>"/>
...
<table style="width:100%;" >
  ...
  <tr>
    <td style="padding-left:8px; text-align:center;"><h2 style="font-size:25px; padding:5px;"><?php echo $pageInnerTitle;?></h1></td>
    </tr>
