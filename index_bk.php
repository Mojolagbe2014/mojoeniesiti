 ...
 <ul class="orion-menu green">
      ...
      <li><a href="<?php echo SITE_URL;?>contact-us">Contact Us</a></li>
				...
				<li class="social hidele">
					...
					<a href="https://plus.google.com/107382097978433122911" target="_blank" style="background:none"><i class="fa fa-google" ></i><span class="tooltip">Google Plus</span></a>
                    ...
                    <a href="http://www.youtube.com/user/nigerianseminars" target="_blank" style="background:none"><i class="fa fa-youtube"></i><span class="tooltip">Youtube</span></a>
				</li>
...
<div class="RightAdd"><?php echo $GetAdverts -> SmallAds("Right Banner","Index");?></div>
	...
	if(NUM_ROWS($result_pre) > 0){
					while($rows_pre = SqlArrays($result_pre)){
                       ...
                       <div >
                      <a href="<?php echo SITE_URL.'events/'.$rows_pre['event_id'].'/'.str_replace($title_link,"-",$rows_pre['event_title']);?>" class="eventListing"><h2 style="font-size:16px;"> <span class="spanTitle"><?php echo $rows_pre['event_title'];?></span></h2>
                      ...
                      <!-- <span class="provider">Provider:</span>-->
                        ...
                        <span style="color:#000; font-weight:600;"><?php echo $rows_pre['organiser'];?></span>
                        </span>
                      
                       </div> 
                       <div style="display:block;"><div class="ViewBox"><img src="images/view-more.png" width="73" height="20" alt="view more nigerian seminars and trainings"></div></div>
                       <div class="clearfix"></div>
                       </a>
  ...
  <div class="slideshow" style="text-align:center;">
    ...
    <div class="button_class">Articles</div>
         ...
         <ul>
            ...
            <div class="TabbedPanelsContent" style="color: #090; font-weight:bold; text-align:center; height:150px" ><br /> "<?php echo $row['quote']; ?>"<br /><span style="font-weight:normal; color: #000"><i><?php  echo $row['authur'];?></i></span>
