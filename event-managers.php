...
<title>Event Managers - Nigerian Seminars and Trainings</title>
<meta name="description" content="List of event managers, masters of ceremonies (MC), compere, event organizers, and ushering services in Nigeria <?php if(isset($_GET['page'])) echo " Page ".$_GET['page'];?>"/>
<link href="images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
<meta name="keywords" content="Conference managers, event managers , masters of ceremonies (MC) , compere , ushers , Conference managers, event managers in nigeria , masters of ceremonies (MC) in nigeria , comperes in nigeria , ushers in nigeria" />
<meta name="dcterms.description" content="List of event managers, masters of ceremonies (MC), compere, event organizers, and ushering services in Nigeria <?php if(isset($_GET['page'])) echo " Page ".$_GET['page'];?>" />
<meta property="og:title" content=">Event Managers - Nigerian Seminars and Trainings <?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />
<meta property="og:description" content="List of event managers, masters of ceremonies (MC), compere, event organizers, and ushering services in Nigeria <?php if(isset($_GET['page'])) echo " Page ".$_GET['page'];?>" />
<meta property="twitter:title" content=">Event Managers - Nigerian Seminars and Trainings <?php if(isset($_GET['page'])) echo "-Pg".$_GET['page'];?>" />
            ...
            <div id="content_left">
                <div class="event_table_inner">
                    <form action="search_venuproviders" method="get" id="searchform" autocomplete="off">
                        <table >
                            <tr>
                            <td style="padding-left:8px"><h2 style="font-size:23px; font-weight: normal; padding:5px;">List of event managers, masters of ceremonies (MC), compere, event organizers, and ushering services in Nigeria </h2></td>
                            </tr>
                            <tr><td><div style="margin-top:2%;text-align:center"><h3 style="font-weight:normal; font-size:11px;"><i>(Search event managers alphabetically)</i></h3></div></td></tr>
                       </table>
                    </form>
                </div>	
                <div id="subpage">
                    <ul id="tabs">
                        <?php 
                                ...
                                foreach($alphas as $alpha){ 
                                    $sqlCmdTr = ''; $alphaStyle = '';
                                    switch($alpha){
                                        case 'PREMIUM': $sqlCmdTr = "SELECT * FROM businessinfo WHERE business_type='Managers' AND status=1 AND  premium !=0 ORDER BY RAND() "; break;
                                        default: $sqlCmdTr = "SELECT * FROM businessinfo WHERE business_type='Managers' AND status=1 AND  premium =0 AND  business_name LIKE '$alpha%' ORDER BY status DESC "; 
                                                 break;
                                    }
                    ...
                    <div id="this-content">
                        ...
                        foreach($alphas as $alpha){
                            ...
                            switch($alpha){
                                    case 'PREMIUM': $sqlCmdTr = "SELECT * FROM businessinfo WHERE business_type='Managers' AND status=1 AND  premium !=0 ORDER BY RAND() "; break;
                                    default: $sqlCmdTr = "SELECT * FROM businessinfo WHERE business_type='Managers' AND status=1 AND  premium =0 AND  business_name LIKE '".$alpha."%' ORDER BY business_name ASC "; 
                                             break;
                            }
