...
function vpb_buy_now(selected_domain_to_buy)
{
	...
	window.location = 'http://www.hostmonster.com/track/nigsemtra2010/GetWebHosting'
	return false;
}
...
{	
	...
	else
	{
		...
		$.ajax({  
			type: "POST",  
			url: "tools/processdomain.php",  
			data: dataString,
			cache: false,
			beforeSend: function() 
			{
				$("#vpb_search_status").html('<p style="font-family:Verdana, Geneva, sans-serif; font-size:12px; text-align:center;">Please wait <img src="images/loadings.gif" align="absmiddle" alt="Loading..." style="vertical-align:middle; margin-left:5px;"></p>');
			},  
