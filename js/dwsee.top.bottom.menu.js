(function ($) {
    $.fn.dwseeTopBottomMenu = function (options) {
        ...
        var settings = $.extend({
            ...
            'position': 'right',
            'openmenusize': 100,
            'topicon': 'http://localhost/nigerianseminars/images/sq_br_up_icon.png',
            'menuicon': 'http://localhost/nigerianseminars/images/2x2_grid_icon.png',
        ...
        $('body')
            .prepend('<div id="top-bottom-menu"><div id="dstbm-top" title="Go Top" ></div><div id="dstbm-menu" title="Socialize With Us"> <div id="dstbmmenu"></div></div></div>')
