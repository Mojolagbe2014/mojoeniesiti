!function($, w, d, undefined) {
	...
	$.extend(true, Currency.prototype = {
		...
		_getCurrencyProviderUrl: function() {
			var providers = {
				rateExchange : 'https://rate-exchange.appspot.com/currency?from={From}&to={To}',
				php5dev : 'https://currency-converter.php5developer.com/api.php?from={From}&to={To}',
			}
			//this.options.rateProvider = 'php5dev';
			var provider = providers[this.options.rateProvider] || providers.rateExchange;
			var params = {
				'{From}' : this.from,
				'{To}' : this.to,
			};
		...
		_getCurrencyRate: function() {
			...
			$.ajax({
				...
				url: url,
				dataType: "JSONP",
				beforeSend: this._currencyLoading(this),
				success: this._currencyResponse(this),
			});
			return false;
		},
	...
	$.fn[name].defaults = {
		...
		fromPopular: [],
		toPopular: [],
		loadingImage: 'http://localhost/nigerianseminars/images/img/loader.gif',
