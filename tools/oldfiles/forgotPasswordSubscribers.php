...
$Email_message .= "<a href='http://www.nigerianseminarsandtrainings.com/reset_password_subscribers?user=".$_POST['email']."&path=email&token=".md5('email')."&type=reset&u=".md5('reset')."'>http://www.nigerianseminarsandtrainings.com/reset_password_subscribers?user=".$_POST['email']."&path=email&token=".md5('email')."&type=reset&u=".md5('reset')."</a>";
