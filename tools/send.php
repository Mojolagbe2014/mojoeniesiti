...
if(isset($_POST['title'])) $course = 'Course Title: '.$_POST['title'].'<br>';

$to = $to_email;
$subject = $title;
$msg = $course." Name: ".$name."<br>"."Email: ".$email."<br>"."Phone: ".$phone."<br>"."Address: ".$address."<br>".$message.'<br><br><br>You are receiving this message courtesy of <a href="http://www.nigerianseminarsandtrainings.com">Nigerian Seminars and Trainings.com</a><br>
