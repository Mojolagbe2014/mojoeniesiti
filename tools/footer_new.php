...
<?php if (!strpos($_SERVER['SCRIPT_NAME'],'subscribers.php') && !strpos($_SERVER['SCRIPT_NAME'],'add-event.php') && !strpos($_SERVER['SCRIPT_NAME'],'vacancies.php') && !strpos($_SERVER['SCRIPT_NAME'],'upload-business-info.php')&& !strpos($_SERVER['SCRIPT_NAME'],'webVacancies.php') && !strpos($_SERVER['SCRIPT_NAME'],'profile.php') && !strpos($_SERVER['SCRIPT_NAME'],'article-submission.php') && !strpos($_SERVER['SCRIPT_NAME'],'authorPage.php') && !strpos($_SERVER['SCRIPT_NAME'],'fullArticle.php')&& !strpos($_SERVER['SCRIPT_NAME'],'profile.php')&& !strpos($_SERVER['SCRIPT_NAME'],'contact-us.php') && !strpos($_SERVER['SCRIPT_NAME'],'my-calendar.php') && !strpos($_SERVER['SCRIPT_NAME'],'edit_event.php') && !strpos($_SERVER['SCRIPT_NAME'],'business_info.php')){?>
