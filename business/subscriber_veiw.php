...
<table border="0" style="float:left; width:100%;">
  ...
  <tr>
    <td width="79%" style="padding-left:8px"><h2 style="font-size:18px; padding:5px;"><i class="fa fa-user"></i>&nbsp; Subscriber Information</h2></td>
						   ...
						   <div id="contact-wrapper-inner" class="rounded">
						     <form action="" method="post" id="contactform2">
                               ...
                               <tr>
						          ...
						          <td width="73%" style="padding-left:350px"><a href="<?php echo SITE_URL;?>business/subscriber_edit">Edit Information</a></td>
					            </tr>
						        <tr>
						        ...
						        <tr>
						          ...
						          <td><span class="contact-left"><?php echo $rows['designation'];?></span></td>
					            </tr>
						        <tr>
