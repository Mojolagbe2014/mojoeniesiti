...
<title>A pessimist sees the difficulty in every opportunity; an op</title>
<meta name="description" content="A pessimist sees the difficulty in every opportunity; an optimist sees the opportunity in every diff - Winston Churchill Quotes"/>
<meta name="dcterms.description" content="A pessimist sees the difficulty in every opportunity; an optimist sees the opportunity in every diff - Winston Churchill Quotes" />
<meta property="og:title" content="A pessimist sees the difficulty in every opportunity; an op... - Winston Churchill" />
<meta property="og:description" content="A pessimist sees the difficulty in every opportunity; an optimist sees the opportunity in every diff - Winston Churchill Quotes" />
<meta property="twitter:title" content="A pessimist sees the difficulty in every opportunity; an op... - Winston Churchill" />
<meta property="twitter:description" content="A pessimist sees the difficulty in every opportunity; an optimist sees the opportunity in every diff - Winston Churchill Quotes" />
...
<tr>
<td style="padding-left:8px"><h2 style="font-size:25px; padding:5px;">Quote of the day - November 28, 2013</h2></td>
</tr>
<tr>
...
<blockquote class="blockQuote" style="margin-top:0px;"><img src="http://localhost/nigerianseminars/images/quote-icon.png" width="44" height="33" alt="Block Quote Image" />&nbsp;A pessimist sees the difficulty in every opportunity; an optimist sees the opportunity in every difficulty.&nbsp;<img src="http://localhost/nigerianseminars/images/quote-icon2.png" width="44" height="33" alt="nigerianseminars" /><br /><br />
<b style="color: #000; font-size:18px; font-style:italic">Winston Churchill</b>
</blockquote>
</div>
<div style="float:left;"> 
<div class="fb-like" data-href="http://localhost/nigerianseminars/quotespg/10-a-pessimist-sees-the-difficulty-in-every-opportunity-an-optimist-sees-the-opportunity-in-every-difficulty" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
<div class="fb-share-button" data-href="http://localhost/nigerianseminars/quotespg/10-a-pessimist-sees-the-difficulty-in-every-opportunity-an-optimist-sees-the-opportunity-in-every-difficulty" data-type="button_count"></div>
