...
<title>You must have long-range goals to keep you from being frust</title>
<meta name="description" content="You must have long-range goals to keep you from being frustrated by short-range failures. - Charles C. Noble Quotes"/>
<meta name="dcterms.description" content="You must have long-range goals to keep you from being frustrated by short-range failures. - Charles C. Noble Quotes" />
<meta property="og:title" content="You must have long-range goals to keep you from being frust... - Charles C. Noble" />
<meta property="og:description" content="You must have long-range goals to keep you from being frustrated by short-range failures. - Charles C. Noble Quotes" />
<meta property="twitter:title" content="You must have long-range goals to keep you from being frust... - Charles C. Noble" />
<meta property="twitter:description" content="You must have long-range goals to keep you from being frustrated by short-range failures. - Charles C. Noble Quotes" />
...
<tr>
<td style="padding-left:8px"><h2 style="font-size:25px; padding:5px;">Quote of the day - February 22, 2014</h2></td>
</tr>
<tr>
...
<blockquote class="blockQuote" style="margin-top:0px;"><img src="http://localhost/nigerianseminars/images/quote-icon.png" width="44" height="33" alt="Block Quote Image" />&nbsp;You must have long-range goals to keep you from being frustrated by short-range failures.&nbsp;<img src="http://localhost/nigerianseminars/images/quote-icon2.png" width="44" height="33" alt="nigerianseminars" /><br /><br />
<b style="color: #000; font-size:18px; font-style:italic">Charles C. Noble</b>
</blockquote>
</div>
<div style="float:left;"> 
<div class="fb-like" data-href="http://localhost/nigerianseminars/quotespg/82-you-must-have-long-range-goals-to-keep-you-from-being-frustrated-by-short-range-failures" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
<div class="fb-share-button" data-href="http://localhost/nigerianseminars/quotespg/82-you-must-have-long-range-goals-to-keep-you-from-being-frustrated-by-short-range-failures" data-type="button_count"></div>
