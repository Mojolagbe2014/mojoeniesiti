...
<title>Do not go where the path may lead, go instead where there i</title>
<meta name="description" content="Do not go where the path may lead, go instead where there is no path and leave a trail.

 - Ralph Waldo Emerson Quotes"/>
<meta name="dcterms.description" content="Do not go where the path may lead, go instead where there is no path and leave a trail.

 - Ralph Waldo Emerson Quotes" />
<meta property="og:title" content="Do not go where the path may lead, go instead where there i... - Ralph Waldo Emerson" />
<meta property="og:description" content="Do not go where the path may lead, go instead where there is no path and leave a trail.

 - Ralph Waldo Emerson Quotes" />
<meta property="twitter:title" content="Do not go where the path may lead, go instead where there i... - Ralph Waldo Emerson" />
<meta property="twitter:description" content="Do not go where the path may lead, go instead where there is no path and leave a trail.
...
<tr>
<td style="padding-left:8px"><h2 style="font-size:25px; padding:5px;">Quote of the day - December 24, 2013</h2></td>
</tr>
<tr>
...
<blockquote class="blockQuote" style="margin-top:0px;"><img src="http://localhost/nigerianseminars/images/quote-icon.png" width="44" height="33" alt="Block Quote Image" />&nbsp;Do not go where the path may lead, go instead where there is no path and leave a trail.
...
<div class="fb-like" data-href="http://localhost/nigerianseminars/quotespg/35-do-not-go-where-the-path-may-lead-go-instead-where-there-is-no-path-and-leave-a-trail" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
<div class="fb-share-button" data-href="http://localhost/nigerianseminars/quotespg/35-do-not-go-where-the-path-may-lead-go-instead-where-there-is-no-path-and-leave-a-trail" data-type="button_count"></div>
