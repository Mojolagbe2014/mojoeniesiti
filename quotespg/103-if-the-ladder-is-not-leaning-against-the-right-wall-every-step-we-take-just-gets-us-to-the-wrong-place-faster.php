...
<title>If the ladder is not leaning against the right wall, every </title>
<meta name="description" content="If the ladder is not leaning against the right wall, every step we take just gets us to the wrong pl - Stephen R. Covey Quotes"/>
<meta name="dcterms.description" content="If the ladder is not leaning against the right wall, every step we take just gets us to the wrong pl - Stephen R. Covey Quotes" />
<meta property="og:title" content="If the ladder is not leaning against the right wall, every ... - Stephen R. Covey" />
<meta property="og:description" content="If the ladder is not leaning against the right wall, every step we take just gets us to the wrong pl - Stephen R. Covey Quotes" />
<meta property="twitter:title" content="If the ladder is not leaning against the right wall, every ... - Stephen R. Covey" />
<meta property="twitter:description" content="If the ladder is not leaning against the right wall, every step we take just gets us to the wrong pl - Stephen R. Covey Quotes" />
...
<tr>
<td style="padding-left:8px"><h2 style="font-size:25px; padding:5px;">Quote of the day - March 23, 2014</h2></td>
</tr>
<tr>
...
<blockquote class="blockQuote" style="margin-top:0px;"><img src="http://localhost/nigerianseminars/images/quote-icon.png" width="44" height="33" alt="Block Quote Image" />&nbsp;If the ladder is not leaning against the right wall, every step we take just gets us to the wrong place faster. &nbsp;<img src="http://localhost/nigerianseminars/images/quote-icon2.png" width="44" height="33" alt="nigerianseminars" /><br /><br />
<b style="color: #000; font-size:18px; font-style:italic">Stephen R. Covey</b>
</blockquote>
</div>
<div style="float:left;"> 
<div class="fb-like" data-href="http://localhost/nigerianseminars/quotespg/103-if-the-ladder-is-not-leaning-against-the-right-wall-every-step-we-take-just-gets-us-to-the-wrong-place-faster" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
<div class="fb-share-button" data-href="http://localhost/nigerianseminars/quotespg/103-if-the-ladder-is-not-leaning-against-the-right-wall-every-step-we-take-just-gets-us-to-the-wrong-place-faster" data-type="button_count"></div>
