...
<title>When you can't understand a problem, go back to the basics </title>
<meta name="description" content="When you can't understand a problem, go back to the basics and you'll start finding some answers. Th - Michael LeBoeuf, Ph.D Quotes"/>
<meta name="dcterms.description" content="When you can't understand a problem, go back to the basics and you'll start finding some answers. Th - Michael LeBoeuf, Ph.D Quotes" />
<meta property="og:title" content="When you can't understand a problem, go back to the basics ... - Michael LeBoeuf, Ph.D" />
<meta property="og:description" content="When you can't understand a problem, go back to the basics and you'll start finding some answers. Th - Michael LeBoeuf, Ph.D Quotes" />
<meta property="twitter:title" content="When you can't understand a problem, go back to the basics ... - Michael LeBoeuf, Ph.D" />
<meta property="twitter:description" content="When you can't understand a problem, go back to the basics and you'll start finding some answers. Th - Michael LeBoeuf, Ph.D Quotes" />
...
<tr>
<td style="padding-left:8px"><h2 style="font-size:25px; padding:5px;">Quote of the day - March 13, 2014</h2></td>
</tr>
<tr>
...
<blockquote class="blockQuote" style="margin-top:0px;"><img src="http://localhost/nigerianseminars/images/quote-icon.png" width="44" height="33" alt="Block Quote Image" />&nbsp;When you can't understand a problem, go back to the basics and you'll start finding some answers. The greatest truths are too important to be new.&nbsp;<img src="http://localhost/nigerianseminars/images/quote-icon2.png" width="44" height="33" alt="nigerianseminars" /><br /><br />
<b style="color: #000; font-size:18px; font-style:italic">Michael LeBoeuf, Ph.D</b>
</blockquote>
</div>
<div style="float:left;"> 
<div class="fb-like" data-href="http://localhost/nigerianseminars/quotespg/95-when-you-cant-understand-a-problem-go-back-to-the-basics-and-youll-start-finding-some-answers-the-greatest-truths-are-too-important-to-be-new" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
<div class="fb-share-button" data-href="http://localhost/nigerianseminars/quotespg/95-when-you-cant-understand-a-problem-go-back-to-the-basics-and-youll-start-finding-some-answers-the-greatest-truths-are-too-important-to-be-new" data-type="button_count"></div>
