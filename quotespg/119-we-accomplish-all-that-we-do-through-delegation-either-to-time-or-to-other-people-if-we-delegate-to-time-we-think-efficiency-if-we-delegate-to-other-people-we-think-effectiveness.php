...
<title>We accomplish all that we do through delegation – either </title>
<meta name="description" content="We accomplish all that we do through delegation – either to time or to other people. If we delegat - Stephen R. Covey Quotes"/>
<meta name="dcterms.description" content="We accomplish all that we do through delegation – either to time or to other people. If we delegat - Stephen R. Covey Quotes" />
<meta property="og:title" content="We accomplish all that we do through delegation – either ... - Stephen R. Covey" />
<meta property="og:description" content="We accomplish all that we do through delegation – either to time or to other people. If we delegat - Stephen R. Covey Quotes" />
<meta property="twitter:title" content="We accomplish all that we do through delegation – either ... - Stephen R. Covey" />
<meta property="twitter:description" content="We accomplish all that we do through delegation – either to time or to other people. If we delegat - Stephen R. Covey Quotes" />
...
<tr>
<td style="padding-left:8px"><h2 style="font-size:25px; padding:5px;">Quote of the day - April 13, 2014</h2></td>
</tr>
<tr>
...
<blockquote class="blockQuote" style="margin-top:0px;"><img src="http://localhost/nigerianseminars/images/quote-icon.png" width="44" height="33" alt="Block Quote Image" />&nbsp;We accomplish all that we do through delegation – either to time or to other people. If we delegate to time, we think efficiency. If we delegate to other people, we think effectiveness. &nbsp;<img src="http://localhost/nigerianseminars/images/quote-icon2.png" width="44" height="33" alt="nigerianseminars" /><br /><br />
<b style="color: #000; font-size:18px; font-style:italic">Stephen R. Covey</b>
</blockquote>
</div>
<div style="float:left;"> 
<div class="fb-like" data-href="http://localhost/nigerianseminars/quotespg/119-we-accomplish-all-that-we-do-through-delegation-either-to-time-or-to-other-people-if-we-delegate-to-time-we-think-efficiency-if-we-delegate-to-other-people-we-think-effectiveness" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div> 
<div class="fb-share-button" data-href="http://localhost/nigerianseminars/quotespg/119-we-accomplish-all-that-we-do-through-delegation-either-to-time-or-to-other-people-if-we-delegate-to-time-we-think-efficiency-if-we-delegate-to-other-people-we-think-effectiveness" data-type="button_count"></div>
