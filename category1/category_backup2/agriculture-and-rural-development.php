...
$keyword = "";
	...
	if(isset($_GET['category'])){
		...
		$pageInnerTitle = 'Conferences, trainings seminars in <span>'.$rows_cat['category_name'].'</span> Category';
...
<link href="<?php echo SITE_URL;?>images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
	...
	<title>Agriculture and Rural Development - Nigerian Seminars and Trainings <?php echo $pg;?></title>

<meta name="description" content="Agriculture and rural development training in Nigeria | agriculture conferences, courses, training in Nigeria, Africa, Asia, North / South America, Europe <?php echo $pg;?>"/>

<meta name="keywords" content="Agriculture and Rural Development Training Seminars, Workshops, Conferences "/>

<meta name="dcterms.description" content="Agriculture and rural development training in Nigeria | agriculture conferences, courses, training in Nigeria, Africa, Asia, North / South America, Europe"/>

<meta property="og:title" content="Agriculture and Rural Development - Nigerian Seminars and Trainings"/>

<meta property="og:description" content="Agriculture and rural development training in Nigeria | agriculture conferences, courses, training in Nigeria, Africa, Asia, North / South America, Europe"/>

<meta property="twitter:title" content="Agriculture and Rural Development - Nigerian Seminars and Trainings"/>

<meta property="twitter:description" content="Agriculture and rural development training in Nigeria | agriculture conferences, courses, training in Nigeria, Africa, Asia, North / South America, Europe"/>
...
<?php include("../tools/search_box.php");?>
		...
		$resultPremium = MysqlSelectQuery("SELECT * FROM `events` WHERE premium = 1 $query ORDER BY  rand(), SortDate limit 0, 30");
			...
			?>
                      <div itemscope itemtype="http://schema.org/Event" class="eventListing" onClick="javascript:url_location('<?php echo SITE_URL.'events/'.$rowsPremium['event_id'].'/'.str_replace($title_link,"-",$rowsPremium['event_title']);?>')">
                       <div class="eventListingInner">
                      <a href="<?php echo SITE_URL.'events/'.$rowsPremium['event_id'].'/'.str_replace($title_link,"-",$rowsPremium['event_title']);?>" class="url" style="display:block; padding:3px;" title="<?php echo $rowsPremium['event_title'];?>"><span class="spanTitle" itemprop="name" ><?php echo $rowsPremium['event_title'];?></span></a> 
                      <div class="innerHeadingPropEvent">
     <p ><?php echo dateDiff($rowsPremium['startDate'], $rowsPremium['endDate']);?>, 
                       <?php echo date('M d',strtotime($rowsPremium['startDate']))." - ".date('d M, Y',strtotime($rowsPremium['endDate']));?> &nbsp;</p>
                         <span style="display:none;" itemprop="startDate" content="<?php echo date('Y-m-d h:m:s',strtotime($rowsPremium['startDate']));?>"><?php echo date('Y-m-d h:m:s',strtotime($rowsPremium['startDate']));?></span>
					   ...
					   <?php echo GetEventLocation($rowsPremium['event_id']);?>
                          ...
                          <meta itemprop="image" content="<?php echo SITE_URL.$logo;?>">
                        <div class="respond">
